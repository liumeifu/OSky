// -----------------------------------------------------------------------
//  <copyright file="CollectionPropertySorter.cs" company="">
...
using OSky.Utility.Exceptions;
using OSky.Utility.Properties;
    ...
    public static class CollectionPropertySorter<T>
    {
        ...
        private static LambdaExpression GetKeySelector(string keyName)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new OSkyException(string.Format(Resources.ObjectExtensions_PropertyNameNotExistsInType, propertyName));
                }
