var mxClient = {
	...
	NO_FO: 0 <= navigator.userAgent.indexOf("Firefox/1.") || 0 <= navigator.userAgent.indexOf("Iceweasel/1.") || 0 <= navigator.userAgent.indexOf("Firefox/2.") || 0 <= navigator.userAgent.indexOf("Iceweasel/2.") || 0 <= navigator.userAgent.indexOf("SeaMonkey/1.") || 0 <= navigator.userAgent.indexOf("Iceape/1.") || 0 <= navigator.userAgent.indexOf("Camino/1.") || 0 <= navigator.userAgent.indexOf("Epiphany/2.") || 0 <= navigator.userAgent.indexOf("Opera/") || 0 <= navigator.userAgent.indexOf("MSIE") || 0 <= navigator.userAgent.indexOf("Mozilla/2."),
	...
	IS_TOUCH: 0 < navigator.userAgent.toUpperCase().indexOf("IPAD") || 0 < navigator.userAgent.toUpperCase().indexOf("IPOD") || 0 < navigator.userAgent.toUpperCase().indexOf("IPHONE") || 0 < navigator.userAgent.toUpperCase().indexOf("ANDROID"),
...
var mxLog = {
	...
	init: function() {
		if (mxLog.window == null && document.body != null) {
			...
			mxLog.window = new mxWindow(a, b, Math.max(0, document.body.clientWidth - 320), Math.max(0, c - 210), 300, 160);
			...
			e = function() {
				for (var g = false, h = 0; h < b.length; h++) {
					...
					if (k instanceof mxGeometryChange || k instanceof mxTerminalChange || k instanceof mxValueChange || k instanceof mxChildChange || k instanceof mxStyleChange) {
						...
						if (i != null) {
							g = true;
							if (k.constructor != mxGeometryChange || a.model.isEdge(k.cell)) mxUtils.setOpacity(i.shape.node, 100 * d / 10);
							else {
								var l = a.getView().scale,
									m = (k.geometry.x - k.previous.x) * l,
									n = (k.geometry.y - k.previous.y) * l,
									o = (k.geometry.width - k.previous.width) * l,
									l = (k.geometry.height - k.previous.height) * l;
								if (d == 0) {
									i.x = i.x - m;
									i.y = i.y - n;
									i.width = i.width - o;
	...
	mxUtils = {
		...
		findNodeByAttribute: function() {
			...
			function(a, b, c) {
				...
				else for (a = a.firstChild; a != null && d == null;) {
			...
			function(a, b, c) {
				...
				return a.ownerDocument.evaluate("//*[@" + b + "='" + c + "']", a.ownerDocument, null, XPathResult.ANY_TYPE, null).iterateNext()
			}
		}(),
		getFunctionName: function(a) {
			var b = null;
			if (a != null) if (a.name != null) b = a.name;
			else {
				a = a.toString();
		...
		parseXml: function() {
			return mxClient.IS_IE && (typeof document.documentMode === "undefined" || document.documentMode < 9) ?
			function(a) {
		...
		getPrettyXml: function(a, b, c) {
			...
			if (a != null) {
				b = b || "  ";
				c = c || "";
				if (a.nodeType == mxConstants.NODETYPE_TEXT) d.push(a.nodeValue);
				else {
					d.push(c + "<" + a.nodeName);
					var e = a.attributes;
		...
		getOuterHtml: function() {
			...
			function(a) {
				if (a != null) {
					...
					if (a.innerHTML.length == 0) b.push("/>");
					else {
						b.push(">");
						b.push(a.innerHTML);
						b.push("</" + a.nodeName + ">")
		...
		toString: function(a) {
			...
			for (c in a) try {
				...
				else if (typeof a[c] == "object") var d = mxUtils.getFunctionName(a[c].constructor),
					b = b + (c + " => [" + d + "]\n");
				else b = b + (c + " = " + a[c] + "\n")
			} catch (e) {
				b = b + (c + "=" + e.message)
		...
		arcToCurves: function(a, b, c, d, e, f, g, h, k) {
			...
			h = m * l - n * o + h / 2;
			k = n * l + m * o + k / 2;
			p = Math.atan2((i - o) / d, (e - l) / c) - Math.atan2(0, 1);
			f = p >= 0 ? p : 2 * Math.PI + p;
		...
		intersectsHotspot: function(a, b, c, d, e, f) {
			...
			if (d > 0) {
				var g = a.getCenterX(),
					...
					k = a.width,
					i = a.height,
					l = mxUtils.getValue(a.style, mxConstants.STYLE_STARTSIZE);
		...
		getOffset: function(a, b) {
			var c = 0,
				d = 0;
			if (b != null && b) var e = document.body,
		...
		getScrollOrigin: function(a) {
			for (var b = document.body, c = document.documentElement, d = new mxPoint(b.scrollLeft || c.scrollLeft, b.scrollTop || c.scrollTop); a != null && a != b && a != c;) {
		...
		setOpacity: function(a, b) {
			mxUtils.isVml(a) ? a.style.filter = b >= 100 ? null : "alpha(opacity=" + b / 5 + ")" : mxClient.IS_IE && (typeof document.documentMode === "undefined" || document.documentMode < 9) ? a.style.filter = b >= 100 ? null : "alpha(opacity=" + b + ")" : a.style.opacity = b / 100
		},
		...
		setStyleFlag: function(a, b, c, d) {
			if (a == null || a.length == 0) a = d || d == null ? b + "=" + c : b + "=0";
			else {
				var e = a.indexOf(b + "=");
				if (e < 0) {
					e = a.charAt(a.length - 1) == ";" ? "" : ";";
					a = d || d == null ? a + e + b + "=" + c : a + e + b + "=0"
				} else var f = a.indexOf(";", e),
					g = "",
					g = f < 0 ? a.substring(e + b.length + 1) : a.substring(e + b.length + 1, f),
					g = d == null ? parseInt(g) ^ c : d ? parseInt(g) | c : parseInt(g) & ~c,
		...
		getScaleForPageCount: function(a, b, c, d) {
			if (a < 1) return 1;
			var c = c != null ? c : mxConstants.PAGE_FORMAT_A4_PORTRAIT,
				d = d != null ? d : 0,
				e = c.width - d * 2,
				c = c.height - d * 2,
		...
		error: function(a, b, c, d) {
			...
			var a = document.body.clientWidth,
				...
				g = new mxWindow(mxResources.get(mxUtils.errorResource) || mxUtils.errorResource, e, (a - b) / 2, d / 4, b, null, false, true);
			if (c) {
				mxUtils.br(e);
...
var mxEvent = {
	...
	removeListener: function() {
		var a = function(a, c, d) {
				if (a.mxListenerList != null) {
					...
					if (a.mxListenerList.length == 0) a.mxListenerList = null
				}
			};
	...
	redirectMouseEvents: function(a, b, c, d, e, f, g) {
		var h = function(a) {
			...
			k = mxClient.IS_TOUCH ? "touchmove" : "mousemove",
			i = mxClient.IS_TOUCH ? "touchend" : "mouseup";
		mxEvent.addListener(a, mxClient.IS_TOUCH ? "touchstart" : "mousedown", function(a) {
	...
	isLeftMouseButton: function(a) {
		return a.button == (mxClient.IS_IE && (typeof document.documentMode === "undefined" || document.documentMode < 9) ? 1 : 0)
	},
	...
	getMainEvent: function(a) {
		(a.type == "touchstart" || a.type == "touchmove") && a.touches != null && a.touches[0] != null ? a = a.touches[0] : a.type == "touchend" && (a.changedTouches != null && a.changedTouches[0] != null) && (a = a.changedTouches[0]);
		return a
	},
...
var mxClipboard = {
	...
	copy: function(a, b) {
		var b = b || a.getSelectionCells(),
			c = a.getExportableCells(b);
...
mxWindow.prototype.setResizable = function(a) {
	if (a) if (this.resize == null) {
		...
		var b = mxClient.IS_TOUCH ? "touchmove" : "mousemove",
			c = mxClient.IS_TOUCH ? "touchend" : "mouseup";
		mxEvent.addListener(this.resize, mxClient.IS_TOUCH ? "touchstart" : "mousedown", mxUtils.bind(this, function(a) {
			this.activate();
			var e = mxEvent.getClientX(a),
				f = mxEvent.getClientY(a),
				g = this.div.offsetWidth,
				h = this.div.offsetHeight,
				k = mxUtils.bind(this, function(a) {
					var b = mxEvent.getClientX(a) - e,
						c = mxEvent.getClientY(a) - f;
...
mxWindow.prototype.installMinimizeHandler = function() {
	...
	mxEvent.addListener(this.minimize, mxClient.IS_TOUCH ? "touchstart" : "mousedown", d)
};
			...
			if (this.maximize.style.display != "none") {
				if (a) {
					...
					if (!mxClient.IS_IE) {
						...
						if (h.overflow == "auto" || this.resize != null) this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - 2 + "px"
					}
...
mxWindow.prototype.installMoveHandler = function() {
	...
	var a = mxClient.IS_TOUCH ? "touchmove" : "mousemove",
	...
	mxEvent.addListener(this.title, mxClient.IS_TOUCH ? "touchstart" : "mousedown", mxUtils.bind(this, function(c) {
		var d = mxEvent.getClientX(c),
			e = mxEvent.getClientY(c),
			f = this.getX(),
			g = this.getY(),
			h = mxUtils.bind(this, function(a) {
				var b = mxEvent.getClientX(a) - d,
					c = mxEvent.getClientY(a) - e;
...
mxDragSource.prototype.mouseUp = function(a) {
	...
	if (this.mouseMoveHandler != null) {
		mxEvent.removeListener(document, mxClient.IS_TOUCH ? "touchmove" : "mousemove", this.mouseMoveHandler);
...
mxDragSource.prototype.dragOver = function(a, b) {
	...
	if (this.previewElement != null) {
		...
		var d = this.isGridEnabled() && a.isGridEnabledEvent(b),
			f = true;
		if (this.currentGuide != null && this.currentGuide.isEnabledForEvent(b)) var f = parseInt(this.previewElement.style.width),
...
mxToolbar.prototype.addItem = function(a, b, c, d, e, f) {
	var g = document.createElement(b != null ? "img" : "button"),
		h = e || (f != null ? "mxToolbarMode" : "mxToolbarItem");
	g.className = h;
	...
	mxEvent.addListener(g, mxClient.IS_TOUCH ? "touchstart" : "mousedown", mxUtils.bind(this, function(a) {
		d != null ? g.setAttribute("src", d) : g.style.backgroundColor = "gray";
		if (f != null) {
			if (this.menu == null) {
...
mxToolbar.prototype.addMode = function(a, b, c, d, e, f) {
	var f = f != null ? f : true,
		g = document.createElement(b != null ? "img" : "button");
...
mxSession.prototype.encodeChanges = function(a, b) {
	for (var c = "", d = b ? -1 : 1, e = b ? a.length - 1 : 0; e >= 0 && e < a.length; e = e + d) var f = this.codec.encode(a[e]),
...
mxSession.prototype.decodeChange = function(a) {
	...
	if (a.nodeType == mxConstants.NODETYPE_ELEMENT) {
		b = a.nodeName == "mxRootChange" ? (new mxCodec(a.ownerDocument)).decode(a) : this.codec.decode(a);
		if (b != null) {
			b.model = this.model;
			b.execute();
			a.nodeName == "mxChildChange" && b.parent == null && this.cellRemoved(b.child)
		}
	}
	return b
};
...
var mxUrlConverter = function() {
		...
		return {
			...
			convert: function(d) {
				if (a && d.indexOf("http://") != 0 && d.indexOf("https://") != 0 && d.indexOf("data:image") != 0) {
					if (b == null) {
...
function mxPanningManager(a) {
	...
	this.panTo = function(c, d, e, f) {
		...
		this.dx = this.dx < 0 && Math.abs(this.dx) < this.border ? this.border + this.dx : this.handleMouseOut ? Math.max(this.dx, 0) : 0;
		if (this.dx == 0) {
...
mxPath.prototype.ellipse = function(a, b, c, d) {
	...
	a = a * this.scale;
	b = b * this.scale;
	if (this.isVml()) this.path.push("at ", Math.round(a), " ", Math.round(b), " ", Math.round(a + c), " ", Math.round(b + d), " ", Math.round(a), " ", Math.round(b + d / 2), " ", Math.round(a), " ", Math.round(b + d / 2));
	else {
		var e = a,
			f = b + d / 2,
			a = a + c,
...
mxPopupMenu.prototype.addSeparator = function(a, b) {
	a = a || this;
	if (this.smartSeparators && !b) a.willAddSeparator = true;
	else if (a.tbody != null) {
...
mxMorphing.prototype.updateAnimation = function() {
	...
	if (this.cells != null) for (var b = 0; b < this.cells.length; b++) this.animateCell(cells[b], a, false);
...
mxImageExport.prototype.drawState = function(a, b) {
	if (a != null) {
		...
		for (var c = a.view.graph, d = c.model.getChildCount(a.cell), e = 0; e < d; e++) this.drawState(c.view.getState(c.model.getChildAt(a.cell, e)), b)
	}
};
		...
		drawShape: function(a, b, c, d) {
			var e = {
				...
				curveTo: function(b, c, d, e, i, l) {
					a.curveTo(this.translate.x + b, this.translate.y + c, this.translate.x + d, this.translate.y + e, this.translate.x + i, this.translate.y + l)
				},
				end: function() {},
				close: function() {
					a.close()
...
mxImageExport.prototype.drawOverlays = function(a, b) {
	a.overlays != null && a.overlays.visit(function(a, d) {
		var e = d.bounds;
		e != null && b.image(e.x, e.y, e.width, e.height, d.image)
	})
};
mxImageExport.prototype.drawShape = function(a, b, c) {
	var d = mxUtils.getNumber(a.style, mxConstants.STYLE_ROTATION, 0),
		e = mxUtils.getValue(a.style, mxConstants.STYLE_DIRECTION, null),
		f = a.style[mxConstants.STYLE_STENCIL_FLIPH],
		g = a.style[mxConstants.STYLE_STENCIL_FLIPV];
	if (f ? !g : g) d = d * -1;
	...
	var h = a.view.scale,
		k = mxUtils.getNumber(a.style, mxConstants.STYLE_STROKEWIDTH, 1) * h;
	b.setStrokeWidth(k);
	var i = k / 2,
		h = this.getBackgroundBounds(a);
	...
	var l = new mxRectangle(h.x - i, h.y - i, h.width + k, h.height + k),
		m = mxUtils.getValue(a.style, mxConstants.STYLE_OPACITY, 100) / 100,
		k = a.style[mxConstants.STYLE_SHAPE],
		n = (i = k == mxConstants.SHAPE_IMAGE) ? null : mxUtils.getValue(a.style, mxConstants.STYLE_GRADIENTCOLOR);
	n == mxConstants.NONE && (n = null);
	var o = mxUtils.getValue(a.style, i ? mxConstants.STYLE_IMAGE_BACKGROUND : mxConstants.STYLE_FILLCOLOR, null);
...
mxImageExport.prototype.drawShadow = function(a, b, c, d, e, f, g, h, k) {
	var i = d * Math.PI / 180,
		d = Math.cos(-i),
		i = Math.sin(-i),
		d = mxUtils.getRotatedPoint(new mxPoint(mxConstants.SHADOW_OFFSET_X, mxConstants.SHADOW_OFFSET_Y), d, i);
	if (e) d.x = d.x * -1;
	if (f) d.y = d.y * -1;
	a.translate(d.x, d.y);
...
mxImageExport.prototype.drawImage = function(a, b, c, d) {
	var e = mxUtils.getValue(a.style, mxConstants.STYLE_IMAGE_ASPECT, 1) == 1,
		f = mxUtils.getValue(a.style, mxConstants.STYLE_IMAGE_FLIPH, 0) == 1,
		a = mxUtils.getValue(a.style, mxConstants.STYLE_IMAGE_FLIPV, 0) == 1;
	b.image(c.x, c.y, c.width, c.height, d, e, f, a)
};
mxImageExport.prototype.drawLabelBackground = function(a, b, c, d) {
	var e = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_BORDERCOLOR),
		f = mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_BACKGROUNDCOLOR);
	e == mxConstants.NONE && (e = null);
	f == mxConstants.NONE && (f = null);
	if (e != null || f != null) {
		var g = c.x,
			a = c.y - mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_PADDING, 0),
			h = c.width,
			c = c.height;
		if (d) {
			g = g + (h - c) / 2;
...
mxImageExport.prototype.drawLabel = function(a, b, c, d, e) {
	...
	f == "left" && (f = null);
	var g = c.y - mxUtils.getValue(a.style, mxConstants.STYLE_LABEL_PADDING, 0),
		h = a.view.graph.isWrapping(a.cell);
...
mxImageExport.prototype.getBackgroundBounds = function(a) {
	if (a.style[mxConstants.STYLE_SHAPE] == mxConstants.SHAPE_SWIMLANE) {
		var b = a.view.scale,
			b = mxUtils.getValue(a.style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_STARTSIZE) * b,
			c = a.width,
			d = a.height;
...
mxImageExport.prototype.getImageBounds = function(a) {
	var b = new mxRectangle(a.x, a.y, a.width, a.height),
		c = a.style;
	if (mxUtils.getValue(c, mxConstants.STYLE_SHAPE) != mxConstants.SHAPE_IMAGE) {
		var a = mxUtils.getValue(c, mxConstants.STYLE_IMAGE_ALIGN, mxConstants.ALIGN_LEFT),
			d = mxUtils.getValue(c, mxConstants.STYLE_IMAGE_VERTICAL_ALIGN, mxConstants.ALIGN_MIDDLE),
			e = mxUtils.getValue(c, mxConstants.STYLE_IMAGE_WIDTH, mxConstants.DEFAULT_IMAGESIZE),
			f = mxUtils.getValue(c, mxConstants.STYLE_IMAGE_HEIGHT, mxConstants.DEFAULT_IMAGESIZE),
...
mxImageExport.prototype.drawMarker = function(a, b, c) {
	var d = null,
		...
		f = e.x - g.x,
		h = e.y - g.y,
		k = Math.max(1, Math.sqrt(f * f + h * h)),
		g = f / k,
		f = h / k,
		h = mxUtils.getValue(b.style, c ? mxConstants.STYLE_STARTSIZE : mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE),
		k = mxUtils.getValue(b.style, mxConstants.STYLE_STROKEWIDTH, 1),
		e = e.clone(),
		i = mxUtils.getValue(b.style, c ? mxConstants.STYLE_STARTARROW : mxConstants.STYLE_ENDARROW),
		l = this.markers[i];
	l != null && (d = l(a, b, i, e, g, f, h, c, k));
	return d
};
mxImageExport.prototype.initShapes = function() {
	...
	this.shapes.connector = {
		...
		drawShape: function(b, c, d, e, f) {
			if (e) {
				...
				this.translatePoint(f, f.length - 1, a.drawMarker(b, c, false));
	...
	this.shapes.arrow = {
		drawShape: function(a, c, d, e) {
			if (e) {
				var d = mxConstants.ARROW_SPACING,
					f = mxConstants.ARROW_WIDTH,
	...
	this.shapes.cylinder = {
		drawShape: function(a, c, d, e) {
			...
			var c = d.x,
				...
				f = d.width,
				d = d.height,
				g = Math.min(mxCylinder.prototype.maxHeight, Math.floor(d / 5));
			a.begin();
			a.moveTo(c, e + g);
...
mxImageExport.prototype.initMarkers = function() {
	...
	a = function(a, c, d, e, f, g, h, k, i) {
		var l = d == mxConstants.ARROW_DIAMOND ? 0.7071 : 0.9862,
			m = f * i * l,
			l = g * i * l,
			f = f * (h + i),
			g = g * (h + i);
...
var mxXmlCanvas2D = function(a) {
		...
		return {
			...
			setDashPattern: function(b) {
				var c = e.createElement("dashpattern");
	...
	mxSvgCanvas2D = function(a, b) {
		var b = b != null ? b : false,
			c = new mxUrlConverter,
			d = true,
			e = true,
			f = true,
			g = function(b, c) {
				var d = a.ownerDocument || document;
				if (d.createElementNS != null) return d.createElementNS(c || mxConstants.NS_SVG, b);
				d = d.createElement(b);
		...
		var i = {
			...
			u = [],
			v = function(a, b) {
				var c = "margin:0px;font-size:" + Math.floor(i.fontSize) + "px;font-family:" + i.fontFamily + ";color:" + i.fontColor + ";";
			...
			w = function(c, e, f, g) {
				if (c != null) {
					...
					e.alpha < 1 && c.setAttribute("opacity", e.alpha);
		...
		return {
			...
			setGradient: function(a, b, c, d, e, f, k) {
				if (a != null && b != null) {
					...
					e = e.toLowerCase();
					f = null;
					if (k == null || k == mxConstants.DIRECTION_SOUTH) f = "s";
					else if (k == mxConstants.DIRECTION_EAST) f = "e";
					else {
						var l = d,
							d = e,
							e = l;
					...
					if (e == null) {
						...
						e.setAttribute("x2", "0%");
						e.setAttribute("y2", "0%");
						k == null || k == mxConstants.DIRECTION_SOUTH ? e.setAttribute("y2", "100%") : k == mxConstants.DIRECTION_EAST ? e.setAttribute("x2", "100%") : k == mxConstants.DIRECTION_NORTH ? e.setAttribute("y1", "100%") : k == mxConstants.DIRECTION_WEST && e.setAttribute("x1", "100%");
						k = g("stop");
			...
			image: function(b, d, e, f, h, k, l, m) {
				...
				k || n.setAttribute("preserveAspectRatio", "none");
			...
			text: function(c, d, h, k, l, m, n, o, p, q) {
				if (e) {
					...
					if (f && q == "html") {
						...
						c = m == "end" ? c + Math.max(0, h - 2) : m == "middle" ? c + h / 2 : c + (h > 0 ? 2 : 0);
						...
						(!b || i.fontFamily != mxConstants.DEFAULT_FONTFAMILY) && p.setAttribute("font-family", i.fontFamily);
...
mxGuide.prototype.move = function(a, b, c) {
	if (this.states != null && (this.horizontal || this.vertical) && a != null && b != null) {
		...
		if (!h && this.guideX != null) this.guideX.node.style.visibility = "hidden";
		else if (this.guideX != null) {
			this.guideX.node.style.visibility = "visible";
			this.guideX.redraw()
		}
		if (!k && this.guideY != null) this.guideY.node.style.visibility = "hidden";
		...
		if (c) {
			if (!h) {
				c = a.x - (this.graph.snap(a.x / e - d.x) + d.x) * e;
...
mxShape.prototype.configureHtmlShape = function(a) {
	if (mxUtils.isVml(a)) this.configureVmlShape(a);
	else {
		a.style.position = "absolute";
		...
		if (b != null && b != mxConstants.NONE) {
			...
			if (this.isDashed) a.style.borderStyle = "dashed";
			else if (this.strokewidth > 0) a.style.borderStyle = "solid";
			a.style.borderWidth = Math.ceil(this.strokewidth * this.scale) + "px"
		} else a.style.borderWidth = "0px";
		b = this.fill;
		a.style.background = "";
		b != null && b != mxConstants.NONE ? a.style.backgroundColor = b : this.points == null && this.configureTransparentBackground(a);
...
mxShape.prototype.getGradientId = function(a, b) {
	...
	var a = a.toLowerCase(),
		b = b.toLowerCase(),
		c = null;
	if (this.gradientDirection == null || this.gradientDirection == mxConstants.DIRECTION_SOUTH) c = "south";
	else if (this.gradientDirection == mxConstants.DIRECTION_EAST) c = "east";
	else {
		var d = a,
			a = b,
			b = d;
...
mxShape.prototype.createSvgGradient = function(a, b, c) {
	...
	if (d == null) {
		...
		d.setAttribute("x2", "0%");
		d.setAttribute("y2", "0%");
		this.gradientDirection == null || this.gradientDirection == mxConstants.DIRECTION_SOUTH ? d.setAttribute("y2", "100%") : this.gradientDirection == mxConstants.DIRECTION_EAST ? d.setAttribute("x2", "100%") : this.gradientDirection == mxConstants.DIRECTION_NORTH ? d.setAttribute("y1", "100%") : this.gradientDirection == mxConstants.DIRECTION_WEST && d.setAttribute("x1", "100%");
...
mxShape.prototype.createPoints = function(a, b, c, d) {
	var e = d ? this.bounds.x : 0,
		d = d ? this.bounds.y : 0,
		f = this.crisp && this.dialect == mxConstants.DIALECT_SVG && mxClient.IS_IE ? 0.5 : 0;
	if (isNaN(this.points[0].x) || isNaN(this.points[0].y)) return null;
	var g = mxConstants.LINE_ARCSIZE * this.scale,
		h = this.points[0];
	...
	for (var a = a + " " + (Math.round(h.x - e) + f) + " " + (Math.round(h.y - d) + f) + " ", k = 1; k < this.points.length; k++) {
		...
		if (this.isRounded && k < this.points.length - 1 && (l != 0 || h != 0) && this.scale > 0.3) {
			var m = Math.sqrt(l * l + h * h),
				l = l * Math.min(g, m / 2) / m,
				h = h * Math.min(g, m / 2) / m,
				a = a + (b + " " + (Math.round(i.x + l - e) + f) + " " + (Math.round(i.y + h - d) + f) + " "),
				h = this.points[k + 1],
				l = h.x - i.x,
				h = h.y - i.y,
				m = Math.max(1, Math.sqrt(l * l + h * h));
			if (m != 0) {
				l = l * Math.min(g, m / 2) / m;
				h = h * Math.min(g, m / 2) / m;
...
mxShape.prototype.updateHtmlShape = function(a) {
	if (a != null) {
		if (mxUtils.isVml(a)) this.updateVmlShape(a);
		else {
		...
		if (this.points != null && this.bounds != null && !mxUtils.isVml(a)) {
			...
			if (this.points.length == 2) {
				var c = this.points[0],
					...
					d = b.x - c.x,
					e = b.y - c.y;
				if (d == 0 || e == 0) a.style.borderStyle = "solid";
				else {
					...
					for (var b = 1 + Math.sqrt(d * d + e * e) / (8 * this.scale), f = d / b, g = e / b, a = c.x - this.bounds.x, c = c.y - this.bounds.y, d = 0; d < b; d++) {
						...
						e.style.height = Math.max(1, 2 * this.scale) + "px";
...
mxShape.prototype.updateVmlShape = function(a) {
	...
	if (this.shadowNode != null) {
		var b = Math.round(mxConstants.SHADOW_OFFSET_X * this.scale),
			c = Math.round(mxConstants.SHADOW_OFFSET_Y * this.scale);
		this.shadowNode.offset = b + "px," + c + "px"
	}
	if (this.bounds != null && !isNaN(this.bounds.x) && !isNaN(this.bounds.y) && !isNaN(this.bounds.width) && !isNaN(this.bounds.height)) {
		var b = 1,
			c = Math.max(0, Math.round(this.bounds.width)),
			d = Math.max(0, Math.round(this.bounds.height));
	...
	if (this.points != null && a.nodeName != "group") if (a.nodeName == "polyline" && a.points != null) {
		...
		if (this.style != null && this.style[mxConstants.STYLE_SMOOTH]) {
			...
			e = d.length;
			if (e > 3) {
				for (var f = this.bounds.x, g = this.bounds.y, b = "m " + Math.round(d[0].x - f) + " " + Math.round(d[0].y - g) + " qb", c = 1; c < e - 1; c++) b = b + (" " + Math.round(d[c].x - f) + " " + Math.round(d[c].y - g));
...
mxShape.prototype.updateSvgBounds = function(a) {
	...
	if (this.isRounded) {
		...
		this.style != null && (d = mxUtils.getValue(this.style, mxConstants.STYLE_ARCSIZE, d) / 100);
		b = Math.min(b * d, c * d);
		a.setAttribute("rx", b);
		a.setAttribute("ry", b)
	}
...
mxShape.prototype.updateVmlGlassPane = function() {
	if (this.bounds != null && this.node.nodeName == "group" && this.style != null && mxUtils.getValue(this.style, mxConstants.STYLE_GLASS, 0) == 1) {
		...
		var a = this.bounds,
			b = Math.ceil(this.strokewidth * this.scale / 2 + 1),
			b = "m " + -b + " " + -b + " l " + -b + " " + Math.round(a.height * 0.4) + " c " + Math.round(a.width * 0.3) + " " + Math.round(a.height * 0.6) + " " + Math.round(a.width * 0.7) + " " + Math.round(a.height * 0.6) + " " + Math.round(a.width + b) + " " + Math.round(a.height * 0.4) + " l " + Math.round(a.width + b) + " " + -b + " x e";
	...
	if (this.node.nodeName == "g" && this.style != null && mxUtils.getValue(this.style, mxConstants.STYLE_GLASS, 0) == 1) {
		if (this.node.glassOverlay == null) {
			if (this.node.ownerSVGElement.glassGradient == null) {
				...
				b.setAttribute("style", "stop-color:#ffffff;stop-opacity:0.9");
				a.appendChild(b);
			...
			this.node.glassOverlay.setAttribute("style", "fill:url(#" + this.node.ownerSVGElement.glassGradient.getAttribute("id") + ");");
			this.node.appendChild(this.node.glassOverlay)
		}
		a = this.bounds;
...
mxShape.prototype.createPath = function(a) {
	var b = this.bounds.x,
		...
		f = 0;
	if (this.direction == "north" || this.direction == "south") var f = (d - e) / 2,
		b = b + f,
		c = c + (e - d) / 2,
		g = d,
		d = e,
	...
	if (this.dialect == mxConstants.DIALECT_SVG) {
		...
		g.setTranslate(b, c);
		if (h != 0) {
			var f = this.bounds.getCenterX(),
				k = this.bounds.getCenterY(),
				h = "rotate(" + h + " " + f + " " + k + ")";
			this.innerNode != null && this.innerNode.setAttribute("transform", h);
			this.foreground != null && this.foreground.setAttribute("transform", h);
...
mxStencil.prototype.renderDom = function(a, b, c, d) {
	var e = a.dialect != mxConstants.DIALECT_SVG,
		f = document.documentMode == 8 ? 1 : a.vmlScale,
		g = a.rotation || 0,
		h = false,
		k = a.style[mxConstants.STYLE_STENCIL_FLIPH],
		i = a.style[mxConstants.STYLE_STENCIL_FLIPV];
	if (k ? !i : i) g = g * -1;
	if (a.direction != null) {
	...
	if (this.bgNode != null || this.fgNode != null) {
		...
		var v = Math.min(m, n),
			...
			r = d != null ? d : {
				...
				fill: a.fill,
				stroke: a.stroke,
				strokeWidth: this.strokewidth == "inherit" ? Number(a.strokewidth) * a.scale : Number(this.strokewidth) * v / (e ? f : 1),
				dashed: a.isDashed,
				dashpattern: [3, 3],
				alpha: a.opacity,
				linejoin: "miter",
			...
			B = function(b, c) {
				...
				if (e) {
					...
					if (c.fill != null) {
						var d = !c.fillColorAssigned ? a.gradient : null,
					...
					c.fill != null && c.fillColorAssigned && b.setAttribute("fill", c.fill);
			...
			C = function(d) {
				...
				if (g == "save") {
					...
					if (e) {
						...
						s = document.createElementNS(mxConstants.NS_SVG, "path");
						B.call(this, s, r);
					...
					var h = this.lastMoveX,
						o = this.lastMoveY,
						i = t + Number(d.getAttribute("x1")) * m,
						g = u + Number(d.getAttribute("y1")) * n,
						k = t + Number(d.getAttribute("x2")) * m,
						d = u + Number(d.getAttribute("y2")) * n,
						o = o + 2 / 3 * (g - o),
						p = k + 2 / 3 * (i - k),
						g = d + 2 / 3 * (g - d);
					z("c " + Math.round(h + 2 / 3 * (i - h)) + " " + Math.round(o) + " " + Math.round(p) + " " + Math.round(g) + " " + Math.round(k) + " " + Math.round(d));
					this.lastMoveX = k;
					this.lastMoveY = d
				} else {
					...
					z(h + " " + x(t + Number(d.getAttribute("x1")) * m) + " " + x(u + Number(d.getAttribute("y1")) * n) + " " + x(t + Number(d.getAttribute("x2")) * m) + " " + x(u + Number(d.getAttribute("y2")) * n) + " " + this.lastMoveX + " " + this.lastMoveY)
				} else if (g == "close") z(e ? "x" : "Z");
				else if (g == "rect" || g == "roundrect") {
					o = g == "roundrect";
					...
					var k = Number(d.getAttribute("rx")) * m,
						g = Number(d.getAttribute("ry")) * n,
						o = Number(d.getAttribute("x-axis-rotation")),
						p = Number(d.getAttribute("large-arc-flag")),
						A = Number(d.getAttribute("sweep-flag")),
					...
					if (e) {
						...
						for (d = 0; d < h.length; d = d + 6) {
							z("c " + Math.round(h[d]) + " " + Math.round(h[d + 1]) + " " + Math.round(h[d + 2]) + " " + Math.round(h[d + 3]) + " " + Math.round(h[d + 4]) + " " + Math.round(h[d + 5]));
					...
					if (o != null) {
						...
						if (e) {
							...
							s.style.height = g + "px";
							s.src = o;
							if (p && A) s.style.rotation = "180";
							else if (p) s.style.flip = "x";
							else if (A) s.style.flip = "y"
						} else {
					...
					if (k != null) {
						...
						if (e) {
							...
							if (o == "top") s.style.top = h + r.fontSize / 2 + "px";
							else if (o == "bottom") s.style.top = h - r.fontSize / 3 + "px";
							s.appendChild(d)
						} else {
							...
							(r.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && s.setAttribute("font-style", "italic");
					...
					if (s != null) {
						...
						if (h) e ? s.stroked = "false" : s.setAttribute("stroke", "none");
						else if (i) e ? s.filled = "false" : s.setAttribute("fill", "none");
						c.appendChild(s)
					}
					q && (q = false)
				} else if (g == "linecap") r.linecap = d.getAttribute("cap");
				else if (g == "linejoin") r.linejoin = d.getAttribute("join");
				else if (g == "miterlimit") r.miterlimit = d.getAttribute("limit");
				else if (g == "dashed") r.dashed = d.getAttribute("dashed") == "1";
				else if (g == "dashpattern") {
					d = d.getAttribute("pattern");
					if (d != null && d.length > 0) r.dashpattern = d.split(" ")
				} else if (g == "strokewidth") {
					r.strokeWidth = d.getAttribute("width") * v;
					if (e) r.strokeWidth = r.strokeWidth / f
				} else if (g == "strokecolor") r.stroke = d.getAttribute("color");
				else if (g == "fillcolor") {
					r.fill = d.getAttribute("color");
					r.fillColorAssigned = true
				} else if (g == "alpha") r.alpha = Number(d.getAttribute("alpha"));
				else if (g == "fontcolor") r.fontColor = d.getAttribute("color");
				else if (g == "fontsize") r.fontSize = Number(d.getAttribute("size")) * v;
				else if (g == "fontfamily") r.fontFamily = d.getAttribute("family");
				else if (g == "fontstyle") r.fontStyle = Number(d.getAttribute("style"))
			};
		if (!e) {
			d = document.createElementNS(mxConstants.NS_SVG, "rect");
...
mxStencil.prototype.drawShape = function(a, b, c, d) {
	...
	if (d != null) {
		var e = mxUtils.getValue(b.style, mxConstants.STYLE_DIRECTION, null),
			c = this.computeAspect(b, c, e),
			e = Math.min(c.width, c.height),
			e = this.strokewidth == "inherit" ? Number(mxUtils.getNumber(b.style, mxConstants.STYLE_STROKEWIDTH, 1)) * b.view.scale : Number(this.strokewidth) * e;
		this.lastMoveY = this.lastMoveX = 0;
		a.setStrokeWidth(e);
		for (d = d.firstChild; d != null;) {
...
mxStencil.prototype.computeAspect = function(a, b, c) {
	var a = b.x,
		...
		e = b.width / this.w0,
		f = b.height / this.h0;
	if (c = c == "north" || c == "south") var f = b.width / this.h0,
		e = b.height / this.w0,
		g = (b.width - b.height) / 2,
		a = a + g,
		d = d - g;
...
mxStencil.prototype.drawNode = function(a, b, c, d) {
	...
	if (e == "save") a.save();
		...
		a.curveTo(f + Number(c.getAttribute("x1")) * h, g + Number(c.getAttribute("y1")) * k, f + Number(c.getAttribute("x2")) * h, g + Number(c.getAttribute("y2")) * k, this.lastMoveX, this.lastMoveY)
	} else if (e == "arc") for (var b = Number(c.getAttribute("rx")) * h, i = Number(c.getAttribute("ry")) * k, d = Number(c.getAttribute("x-axis-rotation")), e = Number(c.getAttribute("large-arc-flag")), l = Number(c.getAttribute("sweep-flag")), f = f + Number(c.getAttribute("x")) * h, g = g + Number(c.getAttribute("y")) * k, c = mxUtils.arcToCurves(this.lastMoveX, this.lastMoveY, b, i, d, e, l, f, g), h = 0; h < c.length; h = h + 6) {
		a.curveTo(c[h], c[h + 1], c[h + 2], c[h + 3], c[h + 4], c[h + 5]);
		this.lastMoveX = c[h + 4];
		this.lastMoveY = c[h + 5]
	} else if (e == "rect") a.rect(f + Number(c.getAttribute("x")) * h, g + Number(c.getAttribute("y")) * k, Number(c.getAttribute("w")) * h, Number(c.getAttribute("h")) * k);
	else if (e == "roundrect") {
		...
		b = Number(b) / 100;
		b = Math.min(i * b, d * b);
		a.roundrect(f + Number(c.getAttribute("x")) * h, g + Number(c.getAttribute("y")) * k, i, d, b, b)
	} else if (e == "ellipse") a.ellipse(f + Number(c.getAttribute("x")) * h, g + Number(c.getAttribute("y")) * k, Number(c.getAttribute("w")) * h, Number(c.getAttribute("h")) * k);
	else if (e == "image") {
		...
		a.text(f + Number(c.getAttribute("x")) * h, g + Number(c.getAttribute("y")) * k, 0, 0, b, c.getAttribute("align"), c.getAttribute("valign"), c.getAttribute("vertical"))
	...
	} else if (e == "fillstroke") a.fillAndStroke();
	else if (e == "fill") a.fill();
	else if (e == "stroke") a.stroke();
	else if (e == "strokewidth") a.setStrokeWidth(Number(c.getAttribute("width")) * i);
	else if (e == "dashed") a.setDashed(c.getAttribute("dashed") == "1");
	else if (e == "dashpattern") {
...
mxStencilShape.prototype.redrawShape = function() {
	if (this.dialect != mxConstants.DIALECT_SVG) {
		...
		var a = Math.round(this.bounds.width),
			b = Math.round(this.bounds.height);
...
var mxMarker = {
	markers: [],
	paintMarker: function(a, b, c, d, e, f, g, h, k, i, l, m) {
		var n = mxMarker.markers[b],
			o = null;
		if (n != null) {
			var o = mxUtils.isVml(a),
				p = d.x - c.x,
				c = d.y - c.y;
			if (isNaN(p) || isNaN(c)) return;
			var q = Math.max(1, Math.sqrt(p * p + c * c)),
				p = p * h / q,
				c = c * h / q,
				d = d.clone();
			if (o) {
			...
			if (o) {
				...
				a.setAttribute("stroke-opacity", l);
				if (k) {
...
(function() {
	var a = function(a, c, d, e, f, g, h, k, i) {
			...
			if (i) {
				...
				a.setAttribute("d", "M " + d.x + " " + d.y + " L " + (d.x - e - f / 2) + " " + (d.y - f + e / 2) + (c != mxConstants.ARROW_CLASSIC ? "" : " L " + (d.x - e * 3 / 4) + " " + (d.y - f * 3 / 4)) + " L " + (d.x + f / 2 - e) + " " + (d.y - f - e / 2) + " z");
...
(function() {
	var a = function(a, c, d, e, f, g, h, k, i) {
			var l = c == mxConstants.ARROW_DIAMOND ? 0.7071 : 0.9862,
				m = e * g * l,
				l = f * g * l,
				e = e * (h + g),
				f = f * (h + g);
			...
			if (i) {
				...
				a.setAttribute("d", "M " + (d.x + e / 2) + " " + (d.y + f / 2) + " L " + (d.x - f / c) + " " + (d.y + e / c) + " L " + (d.x - e / 2) + " " + (d.y - f / 2) + " L " + (d.x + f / c) + " " + (d.y - e / c) + " z");
				a.setAttribute("stroke-width", g * k)
			}
...
mxDoubleEllipse.prototype.redrawVml = function() {
	...
	var a = Math.round((this.strokewidth + 3) * this.scale) * this.vmlScale,
		b = Math.round(this.bounds.width * this.vmlScale),
		c = Math.round(this.bounds.height * this.vmlScale);
...
mxRhombus.prototype.updateSvgNode = function(a) {
	...
	var b = this.bounds.x,
		...
		d = this.bounds.width,
		e = this.bounds.height,
		b = "M " + Math.round(b + d / 2) + " " + Math.round(c) + " L " + Math.round(b + d) + " " + Math.round(c + e / 2) + " L " + Math.round(b + d / 2) + " " + Math.round(c + e) + " L " + Math.round(b) + " " + Math.round(c + e / 2) + " Z ";
	a.setAttribute("d", b);
	this.updateSvgTransform(a, a == this.shadowNode);
	if (this.isDashed) {
		b = Math.max(1, Math.round(3 * this.scale * this.strokewidth));
...
mxArrow.prototype.redrawPath = function(a, b, c) {
	...
	var b = this.spacing * this.scale,
		d = this.arrowWidth * this.scale,
		e = this.endSize * this.scale,
		f = this.points[0],
...
mxText.prototype.createForeignObject = function() {
	var a = document.createElementNS(mxConstants.NS_SVG, "g"),
		b = document.createElementNS(mxConstants.NS_SVG, "foreignObject");
...
mxText.prototype.getOffset = function(a, b, c, d, e) {
	var f = (e = e != null ? e : this.horizontal) ? this.align : this.valign,
		g = e ? this.valign : this.align,
		h = c - a,
		k = d - b;
...
mxText.prototype.getSpacing = function(a) {
	var a = a != null ? a : this.horizontal,
		b = 0,
		c = 0,
		b = this.align == mxConstants.ALIGN_CENTER ? (this.spacingLeft - this.spacingRight) / 2 : this.align == mxConstants.ALIGN_RIGHT ? -this.spacingRight : this.spacingLeft,
		c = this.valign == mxConstants.ALIGN_MIDDLE ? (this.spacingTop - this.spacingBottom) / 2 : this.valign == mxConstants.ALIGN_BOTTOM ? -this.spacingBottom : this.spacingTop;
...
mxText.prototype.updateHtmlTable = function(a, b) {
	var b = b != null ? b : 1,
		c = a.firstChild.firstChild.firstChild;
	...
	c.style.textAlign = this.align == mxConstants.ALIGN_RIGHT ? "right" : this.align == mxConstants.ALIGN_CENTER ? "center" : "left";
...
mxText.prototype.updateTableWidth = function(a) {
	...
	if (this.wrap && this.bounds.width > 0 && this.dialect != mxConstants.DIALECT_SVG) {
		...
		var c = this.getTableSize(a),
			c = Math.min(c.width, (this.horizontal || mxUtils.isVml(this.node) ? this.bounds.width : this.bounds.height) / this.scale);
...
mxText.prototype.redrawTextbox = function() {
	...
	if (this.overflow != "fill") {
		var c = this.getTableSize(b),
			d = c.width * this.scale,
			c = c.height * this.scale,
			e = this.getOffset(this.bounds.width, this.bounds.height, d, c);
		if (!this.horizontal) b.style.filter = this.ieVerticalFilter;
		var f = this.getSpacing(),
			b = this.bounds.x - e.x + f.x * this.scale,
			e = this.bounds.y - e.y + f.y * this.scale,
			g = this.bounds.x,
			f = this.bounds.y,
			h = this.bounds.width,
			k = this.bounds.height;
		if (this.horizontal) {
			var i = Math.round(b - g),
				l = Math.round(e - f),
				m = Math.min(0, Math.round(g + h - b - d - 1)),
				n = Math.min(0, Math.round(f + k - e - c - 1));
			a.inset = i + "px," + l + "px," + m + "px," + n + "px"
		} else {
			n = m = l = i = 0;
			if (this.align == mxConstants.ALIGN_CENTER) n = i = (k - d) / 2;
			else this.align == mxConstants.ALIGN_LEFT ? i = k - d : n = k - d;
			if (this.valign == mxConstants.ALIGN_MIDDLE) m = l = (h - c) / 2;
			else this.valign == mxConstants.ALIGN_BOTTOM ? l = h - c : m = h - c;
...
mxText.prototype.redrawHtmlTable = function() {
	if (!isNaN(this.bounds.x) && !isNaN(this.bounds.y) && !isNaN(this.bounds.width) && !isNaN(this.bounds.height)) {
		var a = this.node,
			...
			c = false,
			d = 1;
		if (mxClient.IS_IE) a.style.removeAttribute("filter");
		else if (mxClient.IS_SF || mxClient.IS_GC) a.style.WebkitTransform = "";
		...
		b.style.zoom = "";
		this.updateHtmlTable(a, d);
		this.updateTableWidth(a);
		this.opacity != null && mxUtils.setOpacity(a, this.opacity);
		a.style.left = "";
		a.style.top = "";
		a.style.height = "";
		var e = parseFloat(b.style.zoom) || 1,
			d = this.bounds.width,
		...
		var e = this.getOffset(this.bounds.width / this.scale, this.bounds.height / this.scale, d, f, c || this.horizontal),
			g = this.getSpacing(c || this.horizontal),
			h = this.bounds.x / this.scale - e.x + g.x,
			k = this.bounds.y / this.scale - e.y + g.y,
			i = this.scale,
			g = 1,
			l = 0,
			m = 0;
		if (!this.horizontal) if (mxClient.IS_IE && mxClient.IS_SVG) a.style.msTransform = "rotate(" + this.verticalTextDegree + "deg)";
		else if (mxClient.IS_IE) {
			a.style.filter = this.ieVerticalFilter;
			l = (d - f) / 2;
			m = -l
		} else if (mxClient.IS_SF || mxClient.IS_GC) a.style.WebkitTransform = "rotate(" + this.verticalTextDegree + "deg)";
		else if (mxClient.IS_OT) a.style.OTransform = "rotate(" + this.verticalTextDegree + "deg)";
		else if (mxClient.IS_MT) {
			a.style.MozTransform = "rotate(" + this.verticalTextDegree + "deg)";
		...
		} else if (!c) if (document.documentMode >= 9) b.style.msTransform = "scale(" + this.scale + ")";
		else if (mxClient.IS_SF || mxClient.IS_GC) b.style.WebkitTransform = "scale(" + this.scale + ")";
		else {
		...
		if (this.overflow != "fill") {
			...
			if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
				...
				if (this.horizontal || c && !mxClient.IS_OT) {
					...
					this.valign == mxConstants.ALIGN_BOTTOM ? c = Math.max(0, f - e / this.scale) * this.scale : this.valign == mxConstants.ALIGN_MIDDLE && (c = Math.max(0, f - e / this.scale) * this.scale / 2);
			...
			if (document.documentMode >= 9 || mxClient.IS_SVG) {
				...
				i = document.documentMode == 8 ? this.scale : 1;
...
mxText.prototype.redrawForeignObject = function() {
	...
	if (mxClient.IS_SF) {
		...
		if (this.backgroundNode != null) {
			...
			this.border != null ? this.backgroundNode.setAttribute("stroke", this.border) : this.backgroundNode.setAttribute("stroke", "none")
		}
	}
	var e = "";
	if (this.overflow != "fill") {
		...
		var f = this.getTableSize(d),
			g = f.width,
			f = f.height;
		d.parentNode != c && c.appendChild(d);
		var e = this.getSpacing(),
			h = this.bounds.x / this.scale + e.x,
			k = this.bounds.y / this.scale + e.y,
			d = this.bounds.width / this.scale,
			c = this.bounds.height / this.scale,
			i = this.getOffset(d, c, g, f);
		if (this.horizontal) {
			h = h - i.x;
			k = k - i.y;
			e = "scale(" + this.scale + ")"
		} else var e = "scale(" + this.scale + ") rotate(" + this.verticalTextDegree + " " + (h + g / 2) + " " + (k + f / 2) + ")",
			l = this.getVerticalOffset(i),
			h = h + l.x,
			k = k + l.y;
		e = e + (" translate(" + h + " " + k + ")");
		if (this.backgroundNode != null) {
		...
		if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
			...
			h = Math.max(0, i.x);
			i = Math.max(0, i.y);
			if (this.horizontal) b.style.clip = "rect(" + i + "px," + (h + d) + "px," + (i + c) + "px," + h + "px)";
			else {
				i = h = 0;
			...
			this.boundingBox = this.horizontal ? new mxRectangle(h * this.scale, k * this.scale, g * this.scale, f * this.scale) : new mxRectangle(h * this.scale, k * this.scale, f * this.scale, g * this.scale)
		}
	} else {
		this.boundingBox = this.bounds.clone();
		e = this.scale;
		...
		if (!this.wrap) d.firstChild.firstChild.firstChild.style.whiteSpace = "nowrap"
	}
	a.setAttribute("transform", e)
};
mxText.prototype.createSvg = function() {
	var a = document.createElementNS(mxConstants.NS_SVG, "g"),
		b = this.isStyleSet(mxConstants.FONT_UNDERLINE) ? "underline" : "none",
		c = this.isStyleSet(mxConstants.FONT_BOLD) ? "bold" : "normal",
		d = this.isStyleSet(mxConstants.FONT_ITALIC) ? "italic" : null;
	...
	a.setAttribute("text-anchor", this.align == mxConstants.ALIGN_RIGHT ? "end" : this.align == mxConstants.ALIGN_CENTER ? "middle" : "start");
...
mxText.prototype.updateSvgValue = function(a) {
	if (this.currentValue != this.value) {
		...
		if (this.value != null) {
			var b = this.isStyleSet(mxConstants.FONT_UNDERLINE) ? "underline" : "none",
				c = this.value.split("\n");
			this.textNodes = Array(c.length);
			for (var d = 0; d < c.length; d++) if (this.isEmptyString(c[d])) this.textNodes[d] = null;
			else {
...
mxText.prototype.redrawSvg = function() {
	if (this.node.nodeName == "foreignObject") this.redrawHtml();
	else {
		...
		var b = this.value,
			c = this.createHtmlTable();
		this.lastValue = null;
		this.value = mxUtils.htmlEntities(this.value, false);
		this.updateHtmlTable(c);
		document.body.appendChild(c);
		var d = c.offsetWidth * this.scale,
			e = c.offsetHeight * this.scale;
		c.parentNode.removeChild(c);
		this.value = b;
		b = 2 * this.scale;
		this.align == mxConstants.ALIGN_CENTER ? b = b + d / 2 : this.align == mxConstants.ALIGN_RIGHT && (b = b + d);
		var c = Math.round(a * 1.3),
			f = this.textNodes != null ? this.textNodes.length : 0,
			g = this.bounds.x,
			h = this.bounds.y,
			g = g + (this.align == mxConstants.ALIGN_RIGHT ? (this.horizontal ? this.bounds.width : this.bounds.height) - this.spacingRight * this.scale : this.align == mxConstants.ALIGN_CENTER ? this.spacingLeft * this.scale + ((this.horizontal ? this.bounds.width : this.bounds.height) - this.spacingLeft * this.scale - this.spacingRight * this.scale) / 2 : this.spacingLeft * this.scale + 1),
			h = h + (this.valign == mxConstants.ALIGN_BOTTOM ? (this.horizontal ? this.bounds.height : this.bounds.width) - (f - 1) * c - this.spacingBottom * this.scale - 4 : this.valign == mxConstants.ALIGN_MIDDLE ? (this.spacingTop * this.scale + (this.horizontal ? this.bounds.height : this.bounds.width) - this.spacingBottom * this.scale - (f - 1.5) * c) / 2 : this.spacingTop * this.scale + c);
		if (this.overflow == "fill") {
		...
		if (this.value.length > 0 && this.backgroundNode != null && this.node.firstChild != null) {
			this.node.firstChild != this.backgroundNode && this.node.insertBefore(this.backgroundNode, this.node.firstChild);
			...
			this.backgroundNode.setAttribute("stroke-width", Math.round(Math.max(1, this.scale)))
		}
		if (this.clipped && this.bounds.width > 0 && this.bounds.height > 0) {
			this.boundingBox = this.bounds.clone();
			if (!this.horizontal) {
...
mxLine.prototype.redrawVml = function() {
	...
	var a = this.bounds.width,
		b = this.bounds.height;
	this.innerNode.path = this.direction == mxConstants.DIRECTION_NORTH || this.direction == mxConstants.DIRECTION_SOUTH ? "m " + Math.round(a / 2) + " 0 l " + Math.round(a / 2) + " " + Math.round(b) + " e" : "m 0 " + Math.round(b / 2) + " l " + Math.round(a) + " " + Math.round(b / 2) + " e"
};
...
mxLine.prototype.redrawSvg = function() {
	...
	if (this.bounds != null) {
		var a = this.bounds.x,
			...
			d = this.bounds.height,
			e = null,
			e = this.direction == mxConstants.DIRECTION_NORTH || this.direction == mxConstants.DIRECTION_SOUTH ? "M " + Math.round(a + c / 2) + " " + Math.round(b) + " L " + Math.round(a + c / 2) + " " + Math.round(b + d) : "M " + Math.round(a) + " " + Math.round(b + d / 2) + " L " + Math.round(a + c) + " " + Math.round(b + d / 2);
...
mxImageShape.prototype.create = function() {
	...
	if (this.dialect == mxConstants.DIALECT_SVG) {
		...
		var a = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_FLIPH, 0) == 1,
			b = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_FLIPV, 0) == 1,
			c = this.image.toUpperCase();
...
mxImageShape.prototype.updateAspect = function(a, b) {
	var c = Math.min(this.bounds.width / a, this.bounds.height / b),
		a = Math.max(0, Math.round(a * c)),
		b = Math.max(0, Math.round(b * c)),
		c = Math.max(0, Math.round((this.bounds.width - a) / 2)),
		d = Math.max(0, Math.round((this.bounds.height - b) / 2)),
		e = this.imageNode.style;
...
mxImageShape.prototype.redraw = function() {
	...
	if (this.imageNode != null && this.bounds != null) {
		...
		if (this.dialect == mxConstants.DIALECT_SVG) {
			...
			this.imageNode.setAttribute("transform", (this.imageNode.getAttribute("transform") || "") + " scale(" + c + " " + d + ") translate(" + e + " " + f + ")")
		} else {
			...
			if (a || b) if (mxUtils.isVml(this.imageNode)) a && b ? this.imageNode.style.rotation = "180" : this.imageNode.style.flip = a ? "x" : "y";
			else {
				c = this.imageNode.nodeName == "DIV" ? "progid:DXImageTransform.Microsoft.AlphaImageLoader (src='" + this.image + "', sizingMethod='scale')" : "";
...
mxLabel.prototype.redraw = function() {
	this.updateBoundingBox();
	var a = this.dialect == mxConstants.DIALECT_SVG,
		b = mxUtils.isVml(this.node);
	if (a) {
		this.updateSvgShape(this.innerNode);
		this.shadowNode != null && this.updateSvgShape(this.shadowNode);
		this.updateSvgGlassPane()
	...
	var g = this.style[mxConstants.STYLE_IMAGE_ALIGN],
		...
		k = this.spacing * this.scale + 5,
		i = Math.max(b, e),
		l = c + d + f,
		m = a ? this.bounds.x : 0,
		m = g == mxConstants.ALIGN_RIGHT ? m + (this.bounds.width - i - k) : g == mxConstants.ALIGN_CENTER ? m + (this.bounds.width - i) / 2 : m + k,
		g = a ? this.bounds.y : 0,
		g = h == mxConstants.ALIGN_BOTTOM ? g + (this.bounds.height - l - k) : h == mxConstants.ALIGN_TOP ? g + k : g + (this.bounds.height - l) / 2;
	if (this.imageNode != null) if (a) {
		this.imageNode.setAttribute("x", m + (i - b) / 2 + "px");
		this.imageNode.setAttribute("y", g + "px");
		this.imageNode.setAttribute("width", b + "px");
	...
	if (this.indicator != null) {
		...
		this.indicatorImageNode.setAttribute("width", e + "px");
...
mxConnector.prototype.redrawVml = function() {
	if (this.node != null && this.points != null && this.bounds != null && !isNaN(this.bounds.x) && !isNaN(this.bounds.y) && !isNaN(this.bounds.width) && !isNaN(this.bounds.height)) {
		var a = Math.max(0, Math.round(this.bounds.width)),
			b = Math.max(0, Math.round(this.bounds.height)),
			c = a + "," + b,
			a = a + "px",
			b = b + "px";
		if (this.start != null) {
			...
			var d = this.points[1],
				e = this.points[0],
				f = mxUtils.getNumber(this.style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_MARKERSIZE);
...
mxConnector.prototype.redrawSvg = function() {
	if (this.points != null && this.points[0] != null) {
		...
		if (this.start != null) {
			var b = this.points[1],
				c = this.points[0],
				d = mxUtils.getNumber(this.style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_MARKERSIZE);
...
mxSwimlane.prototype.createHtml = function() {
	...
	mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, true) ? this.content.style.borderTopStyle = "none" : this.content.style.borderLeftStyle = "none";
...
mxSwimlane.prototype.createVml = function() {
	var a = document.createElement("v:group"),
		b = this.isRounded ? "v:roundrect" : "v:rect";
	...
	a.style.background = "";
	this.isRounded && this.content.setAttribute("arcsize", "4%");
	this.fill = b;
...
mxSwimlane.prototype.redrawVml = function() {
	var a = Math.round(this.bounds.x),
		b = Math.round(this.bounds.y),
		c = Math.round(this.bounds.width),
		d = Math.round(this.bounds.height);
	this.updateVmlShape(this.node);
	...
	if (mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, true)) {
		...
		if (this.separator != null) this.separator.path = "m " + (c - a) + " " + (e - b) + " l " + (c - a) + " " + (d - b) + " e"
	} else {
...
mxSwimlane.prototype.redrawSvg = function() {
	...
	if (this.shadowNode != null) {
		this.updateSvgShape(this.shadowNode);
		b ? this.shadowNode.setAttribute("height", c) : this.shadowNode.setAttribute("width", c)
	}
	this.isRounded = a;
	...
	if (this.imageNode != null) {
		this.imageNode.setAttribute("x", a + e - this.imageSize - 4);
...
mxGraphLayout.prototype.getConstraint = function(a, b) {
	var c = this.graph.view.getState(b),
		c = c != null ? c.style : this.graph.getCellStyle(b);
			...
			if (d == null || d) {
				...
				if (d > 0) for (f = 0; f < d; f++) {
					var g = this.graph.model.getEdgeAt(a, f),
						h = this.graph.model.getTerminal(g, true) == a;
...
mxGraphLayout.prototype.getVertexBounds = function(a) {
	...
	if (this.useBoundingBox) {
		...
		if (c != null && c.text != null && c.text.boundingBox != null) var d = this.graph.getView().scale,
	...
	try {
		for (var c = a.length - 1; c >= 0; c--) {
			var d = a[c],
				...
				h = 0,
				k = 0;
			if (this.graph.isSwimlane(d)) var i = this.graph.getStartSize(d),
				h = i.width,
				k = i.height;
			if (f != null && g != null) {
				g = g.clone();
...
mxStackLayout.prototype.execute = function(a) {
	if (a != null) {
		...
		var e = e - (2 * this.spacing + 2 * this.border),
			f = this.graph.isSwimlane(a) ? this.graph.getStartSize(a) : new mxRectangle,
			e = e - (b ? f.height : f.width),
			g = this.x0 + f.width + this.border,
			f = this.y0 + f.height + this.border;
		c.beginUpdate();
		try {
			for (var h = 0, k = null, i = c.getChildCount(a), l = 0; l < i; l++) {
				var m = c.getChildAt(a, l);
				if (!this.isVertexIgnored(m) && this.isVertexMovable(m)) {
					var n = c.getGeometry(m);
					if (n != null) {
						n = n.clone();
						...
						if (k != null) b ? n.x = k.x + k.width + this.spacing : n.y = k.y + k.height + this.spacing;
						else if (!this.keepFirstLocation) b ? n.x = g : n.y = f;
						b ? n.y = f : n.x = g;
...
mxCompactTreeLayout.prototype.execute = function(a, b) {
	this.parent = a;
	var c = this.graph.getModel();
	if (b == null) if (this.graph.getEdges(a, c.getParent(a), this.invert, !this.invert, false).length > 0) b = a;
	else {
	...
	if (a != null && c[d] == null && !this.isVertexIgnored(a)) {
		...
		for (var e = this.createNode(a), d = this.graph.getModel(), f = null, a = this.graph.getEdges(a, b, this.invert, !this.invert, false, true), g = this.graph.getView(), h = 0; h < a.length; h++) {
			...
			if (!this.isEdgeIgnored(k)) {
				...
				var i = g.getState(k),
					k = i != null ? i.getVisibleTerminal(this.invert) : g.getVisibleTerminal(k, this.invert),
					i = this.dfs(k, b, c);
...
mxCompactTreeLayout.prototype.processNodeOutgoing = function(a) {
	...
	for (var f = this.minEdgeJetty - this.prefVertEdgeOff, g = 0, h = this.getVertexBounds(c), k = 0; k < e.length; k++) {
		for (var i = e[k].cell.cell, l = this.getVertexBounds(i), i = this.graph.getEdgesBetween(c, i, false), m = [], n = 0, o = 0, p = 0; p < i.length; p++) {
			if (this.horizontal) {
				n = h.x + h.width;
				o = h.y + b;
...
mxFastOrganicLayout.prototype.execute = function(a) {
	...
	this.radius = [];
	this.radiusSquared = [];
	if (this.forceConstant < 0.0010) this.forceConstant = 0.0010;
	...
	try {
		for (d = 0; d < f; d++) {
			...
			var o = this.graph.getConnections(this.vertexArray[d], a),
				c = this.graph.getOpposites(o, this.vertexArray[d]);
			this.neighbours[d] = [];
			for (i = 0; i < c.length; i++) {
				this.resetEdges && this.graph.resetEdge(o[i]);
				this.disableEdgeStyle && this.setEdgeStyleEnabled(o[i], false);
				var h = mxCellPath.create(c[i]),
					p = this.indices[h];
	...
	try {
		for (var c = 0, d = null, e = null, f = [], g = b.getChildCount(a), h = 0; h < g; h++) {
			...
			if (this.isVertexIgnored(k)) {
				...
				f.push(k);
				var i = this.getVertexBounds(k),
					d = d == null ? i.y : Math.min(d, i.y),
					e = e == null ? i.x : Math.min(e, i.x),
					c = Math.max(c, Math.max(i.width, i.height))
			}
		}
		var l = this.getRadius(f.length, c);
		if (this.moveCircle) {
			e = this.x0;
			d = this.y0
		}
...
mxParallelEdgeLayout.prototype.getEdgeId = function(a) {
	var b = this.graph.getView(),
		c = b.getState(a),
		d = c != null ? c.getVisibleTerminal(true) : b.getVisibleTerminal(a, true),
		a = c != null ? c.getVisibleTerminal(false) : b.getVisibleTerminal(a, false);
	if (d != null && a != null) {
...
mxParallelEdgeLayout.prototype.layout = function(a) {
	var b = a[0],
		c = this.graph.getModel(),
		d = c.getGeometry(c.getTerminal(b, true)),
		e = c.getGeometry(c.getTerminal(b, false));
	...
	for (a = 0; a < b.length; a++) {
		...
		for (e = 0; e < d.length; e++) {
			...
			if (g != null && g.length > 0) {
				var g = g[0],
					k = h.getView().getVisibleTerminal(g, false),
...
mxGraphHierarchyModel.prototype.createInternalCells = function(a, b, c) {
	for (var d = a.getGraph(), e = 0; e < b.length; e++) {
		...
		var f = a.getEdges(b[e]),
			f = d.getOpposites(f, b[e]);
		c[e].connectsAsSource = [];
		for (var g = 0; g < f.length; g++) {
			var h = f[g];
			if (h != b[e] && a.graph.model.isVertex(h) && !a.isVertexIgnored(h)) {
				var k = d.getEdgesBetween(b[e], h, false),
					i = d.getEdgesBetween(b[e], h, true),
					h = mxCellPath.create(k[0]);
				if (k != null && k.length > 0 && this.edgeMapper[h] == null && i.length * 2 >= k.length) {
					for (var i = new mxGraphHierarchyEdge(k), l = 0; l < k.length; l++) {
						var m = k[l],
							h = mxCellPath.create(m);
						this.edgeMapper[h] = i;
						d.resetEdge(m);
	...
	for (var e = a.slice(); a.length > 0;) {
		...
		for (b = 0; b < f.length; b++) {
			...
			if (i.temp[0] == 5270620) {
				...
				k = this.scanRanksFromSinks ? Math.max(k, i.temp[0] + 1) : Math.min(k, i.temp[0] - 1)
			} else {
				h = false;
				break
			}
...
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing = function(a, b) {
	...
	for (h = 0; h < e; h++) for (k = 0; k < f; k++) if (g[h][k] == 201207) {
		...
		for (d = 0; d < h; d++) for (i = k + 1; i < f; i++) g[d][i] == 201207 && c++
	}
	return c / 2
};
mxMedianHybridCrossingReduction.prototype.transpose = function(a, b) {
	for (var c = true, d = 0; c && d++ < 10;) for (var e = a % 2 == 1 && d % 2 == 1, c = false, f = 0; f < b.ranks.length; f++) {
		for (var g = b.ranks[f], h = [], k = 0; k < g.length; k++) {
			var i = g[k],
				l = i.getGeneralPurposeVariable(f);
			l < 0 && (l = k);
			h[l] = i
		}
...
mxMedianHybridCrossingReduction.prototype.weightedMedian = function(a, b) {
	var c = a % 2 == 0;
	if (c) for (var d = b.maxRank - 1; d >= 0; d--) this.medianRank(d, c);
...
mxMinimumCycleRemover.prototype.execute = function() {
	var a = this.layout.getModel(),
		b = {},
		c = mxUtils.clone(a.vertexMapper, null, true),
		d = null;
	...
	d = null;
	c.lenth > 0 && (d = mxUtils.clone(c, null, true));
...
mxCoordinateAssignment.prototype.minNode = function(a) {
	...
	for (f = 0; b.length > 0 && f <= a;) {
		var h = b.shift(),
			e = h.cell,
			k = h.weightedValue,
			i = parseInt(h.rankIndex),
			g = e.getNextLayerConnectedCells(k),
			l = e.getPreviousLayerConnectedCells(k),
			m = g.length,
			n = l.length,
			o = this.medianXValue(g, k + 1),
			p = this.medianXValue(l, k - 1),
			q = m + n,
...
mxCoordinateAssignment.prototype.medianPos = function(a, b) {
	if (a % 2 == 0) for (var c = b.maxRank; c > 0; c--) this.rankMedianPosition(c - 1, b, c);
...
mxCoordinateAssignment.prototype.rankMedianPosition = function(a, b, c) {
	...
	for (f = 0; f < d.length; f++) {
		...
		for (var i = 0, k = -1E8, l = d[f].rankIndex - 1; l >= 0;) {
			var m = mxCellPath.create(b[l].getCoreCell()),
				m = e[m];
			if (m != null) {
				var n = m.cell;
				if (m.visited) {
		...
		if (h >= k && h <= n) g.setGeneralPurposeVariable(a, h);
		else if (h < k) {
...
mxCoordinateAssignment.prototype.rankCoordinates = function(a, b, c) {
	for (var b = c.ranks[a], c = 0, d = this.initialX + (this.widestRankValue - this.rankWidths[a]) / 2, e = false, f = 0; f < b.length; f++) {
		...
		if (g.isVertex()) {
			...
			h = 1;
			g.edges != null ? h = g.edges.length : mxLog.warn("edge.edges is null");
...
mxCoordinateAssignment.prototype.calculateWidestRank = function(a, b) {
	...
	for (var e = b.maxRank; e >= 0; e--) {
		...
		d = f;
		c = this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_WEST ? c + h : c - h;
	...
	for (d in c) {
		...
		if (!(e.maxRank - e.minRank - 1 < 1)) {
			...
			if (!g) {
				...
				if (g > h || f > h) if (g >= f) for (k = e.maxRank - 2; k > e.minRank; k--) e.setX(k, l[k - e.minRank - 1]);
				else if (f > g) for (k = e.minRank + 2; k < e.maxRank; k++) e.setX(k, i[k - e.minRank - 2])
			}
		}
	}
};
...
mxCoordinateAssignment.prototype.setCellLocations = function(a, b) {
	...
	(this.edgeStyle == mxHierarchicalEdgeStyle.ORTHOGONAL || this.edgeStyle == mxHierarchicalEdgeStyle.POLYLINE) && this.localEdgeProcessing(b);
...
mxCoordinateAssignment.prototype.setEdgePosition = function(a) {
	...
	if (a.temp[0] != 101207) {
		...
		for (var e = 0, f = this.jettyPositions[mxCellPath.create(a.edges[0])], g = a.isReversed ? a.target.cell : a.source.cell, h = 0; h < a.edges.length; h++) {
			var k = a.edges[h],
				i = this.layout.graph.view.getVisibleTerminal(k, true),
				l = [],
				m = a.isReversed;
			i != g && (m = !m);
			if (f != null) {
				var i = m ? 2 : 0,
					n = m ? this.rankTopY[d] : this.rankBottomY[c],
					o = f[e * 4 + 1 + i];
				m && (o = -o);
				n = n + o;
				i = f[e * 4 + i];
			...
			for (; a.maxRank != a.minRank && p != i; p = p + n) {
				var q = a.x[p] + b,
					t = (this.rankTopY[o] + this.rankBottomY[o + 1]) / 2,
					u = (this.rankTopY[o - 1] + this.rankBottomY[o]) / 2;
				if (m) var v = t,
					t = u,
					u = v;
				if (this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_SOUTH) {
					l.push(new mxPoint(q, t));
...
mxHierarchicalLayout.prototype.getEdges = function(a) {
	...
	for (f = 0; f < c.length; f++) {
		...
		e = e != null ? e.getVisibleTerminal(false) : this.graph.view.getVisibleTerminal(c[f], false);
...
mxHierarchicalLayout.prototype.run = function(a) {
	...
	for (var f = 0; f < this.roots.length; f++) {
		...
		if (g) {
			...
			for (g = {}; h.length > 0;) {
				var i = h.shift(),
					l = mxCellPath.create(i);
				if (g[l] == null) {
					g[l] = i;
					if (this.fixRoots) for (var m = this.graph.getIncomingEdges(i, a), l = 0; l < m.length; l++) k.push(m[l]);
...
mxGraphModel.prototype.parentForCellChanged = function(a, b, c) {
	...
	if (b != null)(b != d || d.getIndex(a) != c) && b.insert(a, c);
	else if (d != null) {
		c = d.getIndex(a);
		d.remove(c)
...
mxGraphModel.prototype.getEdges = function(a, b, c, d) {
	for (var b = b != null ? b : true, c = c != null ? c : true, d = d != null ? d : true, e = this.getEdgeCount(a), f = [], g = 0; g < e; g++) {
		var h = this.getEdgeAt(a, g),
			k = this.getTerminal(h, true),
			i = this.getTerminal(h, false);
...
mxGraphModel.prototype.getOpposites = function(a, b, c, d) {
	...
	if (a != null) for (var f = 0; f < a.length; f++) {
		var g = this.getTerminal(a[f], true),
			h = this.getTerminal(a[f], false);
	...
	try {
		for (var e = a.getChildCount(), f = 0; f < e; f++) {
			...
			if (typeof g.getId == "function") {
				var h = g.getId(),
					k = h != null && (!this.isEdge(g) || !c) ? this.getCell(h) : null;
				if (k == null) {
					var i = g.clone();
					i.setId(h);
...
mxChildChange.prototype.execute = function() {
	var a = this.model.getParent(this.child),
		b = a != null ? a.getIndex(this.child) : 0;
...
var mxCellPath = {
	...
	compare: function(a, b) {
		for (var c = Math.min(a.length, b.length), d = 0, e = 0; e < c; e++) if (a[e] != b[e]) {
			if (a[e].length == 0 || b[e].length == 0) d = a[e] == b[e] ? 0 : a[e] > b[e] ? 1 : -1;
			else {
				c = parseInt(a[e]);
				e = parseInt(b[e]);
				d = c == e ? 0 : c > e ? 1 : -1
	...
	mxPerimeter = {
		RectanglePerimeter: function(a, b, c, d) {
			...
			if (d) {
				if (c.x >= a.x && c.x <= a.x + a.width) g.x = c.x;
				else if (c.y >= a.y && c.y <= a.y + a.height) g.y = c.y;
				if (c.x < a.x) g.x = a.x;
				else if (c.x > a.x + a.width) g.x = a.x + a.width;
				if (c.y < a.y) g.y = a.y;
				else if (c.y > a.y + a.height) g.y = a.y + a.height
			}
			return g
		},
		...
		RhombusPerimeter: function(a, b, c, d) {
			...
			return k < g ? c < h ? mxUtils.intersection(k, c, i, l, g, e, b, h) : mxUtils.intersection(k, c, i, l, g, e + a, b, h) : c < h ? mxUtils.intersection(k, c, i, l, g, e, b + f, h) : mxUtils.intersection(k, c, i, l, g, e + a, b + f, h)
		},
		TrianglePerimeter: function(a, b, c, d) {
			var b = b != null ? b.style[mxConstants.STYLE_DIRECTION] : null,
				e = b == mxConstants.DIRECTION_NORTH || b == mxConstants.DIRECTION_SOUTH,
				f = a.x,
				g = a.y,
				h = a.width,
				a = a.height,
			...
			if (b == mxConstants.DIRECTION_NORTH) {
				...
				m = new mxPoint(k, g + a);
				n = new mxPoint(f + h, g)
			} else if (b == mxConstants.DIRECTION_WEST) {
				l = new mxPoint(f + h, g);
				m = new mxPoint(f, i);
				n = new mxPoint(f + h, g + a)
			}
			var o = c.x - k,
				p = c.y - i,
				o = e ? Math.atan2(o, p) : Math.atan2(p, o),
				q = e ? Math.atan2(h, a) : Math.atan2(a, h),
				p = false,
				p = b == mxConstants.DIRECTION_NORTH || b == mxConstants.DIRECTION_WEST ? o > -q && o < q : o < -Math.PI + q || o > Math.PI - q,
				q = null;
			if (p) q = d && (e && c.x >= l.x && c.x <= n.x || !e && c.y >= l.y && c.y <= n.y) ? e ? new mxPoint(c.x, l.y) : new mxPoint(l.x, c.y) : b == mxConstants.DIRECTION_NORTH ? new mxPoint(f + h / 2 + a * Math.tan(o) / 2, g + a) : b == mxConstants.DIRECTION_SOUTH ? new mxPoint(f + h / 2 - a * Math.tan(o) / 2, g) : b == mxConstants.DIRECTION_WEST ? new mxPoint(f + h, g + a / 2 + h * Math.tan(o) / 2) : new mxPoint(f, g + a / 2 - h * Math.tan(o) / 2);
			else {
				if (d) {
					d = new mxPoint(k, i);
					if (c.y >= g && c.y <= g + a) {
...
mxPrintPreview.prototype.open = function(a) {
	...
	try {
		...
		if (this.wnd == null) {
			...
			f.width = f.width / h;
			f.height = f.height / h;
			var i = this.pageFormat.width - this.border * 2,
				l = this.pageFormat.height - this.border * 2,
				m = Math.max(1, Math.ceil((f.width + this.x0) / i)),
				n = Math.max(1, Math.ceil((f.height + this.y0) / l));
			this.pageCount = m * n;
			...
			if (mxClient.IS_IE && document.documentMode != 9) {
				var p = [],
					...
					v = mxImageShape.prototype.updateAspect,
					w = function() {
						if (t && q == 0) {
		...
		c != null && c.parentNode != null && c.parentNode.removeChild(c)
	} finally {
...
mxPrintPreview.prototype.renderPage = function(a, b, c, d, e) {
	...
	try {
		...
		var h = this.graph.getView(),
			k = this.graph.container;
		this.graph.container = g;
		var i = h.getCanvas(),
			l = h.getBackgroundPane(),
			m = h.getDrawPane(),
			n = h.getOverlayPane();
		...
		try {
			var t = [this.graph.getModel().getRoot()],
				a = new mxTemporaryCellStates(h, e, t)
		} finally {
			if (mxClient.IS_IE) h.overlayPane.innerHTML = "";
			else for (var u = g.firstChild; u != null;) {
				var v = u.nextSibling,
...
mxCellEditor.prototype.init = function() {
	...
	mxEvent.addListener(this.textarea, "keydown", mxUtils.bind(this, function(a) {
		if (!mxEvent.isConsumed(a)) if (a.keyCode == 113 || this.graph.isEnterStopsCellEditing() && a.keyCode == 13 && !mxEvent.isControlDown(a) && !mxEvent.isShiftDown(a)) {
...
mxCellEditor.prototype.startEditing = function(a, b) {
	...
	if (c != null) {
		...
		var d = this.graph.getView().scale,
			...
			g = this.graph.model.isEdge(c.cell) ? mxConstants.ALIGN_LEFT : mxUtils.getValue(c.style, mxConstants.STYLE_ALIGN, mxConstants.ALIGN_LEFT),
...
mxCellEditor.prototype.getEditorBounds = function(a) {
	...
	if (a.text != null && a.text.boundingBox != null) if (b) {
		...
		h.width = Math.max(h.width, a.text.boundingBox.width);
	...
	if (this.graph.getModel().isVertex(a.cell)) {
		...
		if (b == mxConstants.ALIGN_LEFT) h.x = h.x - a.width;
		else if (b == mxConstants.ALIGN_RIGHT) h.x = h.x + a.width;
		b = mxUtils.getValue(a.style, mxConstants.STYLE_VERTICAL_LABEL_POSITION, mxConstants.ALIGN_MIDDLE);
		if (b == mxConstants.ALIGN_TOP) h.y = h.y - a.height;
		else if (b == mxConstants.ALIGN_BOTTOM) h.y = h.y + a.height
	}
	return h
};
...
mxCellRenderer.prototype.initialize = function(a, b) {
	...
	if (a.view.graph.container != null && a.shape == null && a.cell != a.view.currentRoot && (c.isVertex(a.cell) || c.isEdge(a.cell))) {
		...
		if (a.shape != null && (b == null || b)) {
			...
			if (a.view.graph.ordered || c.isEdge(a.cell)) a.invalidOrder = true;
			else if (a.view.graph.keepEdgesInForeground && this.firstEdge != null) this.firstEdge.parentNode == a.shape.node.parentNode ? this.insertState(a, this.firstEdge) : this.firstEdge = null;
...
mxCellRenderer.prototype.orderEdge = function(a) {
	...
	if (b.graph.keepEdgesInForeground) {
		...
		var d = a.shape.node,
			...
			b = b.getState(c),
			e = b != null && b.shape != null && b.shape.node != null ? b.shape.node.nextSibling : e.firstChild;
...
mxCellRenderer.prototype.createShape = function(a) {
	if (a.style != null) {
		...
		if (b != null) a.shape = new mxStencilShape(b);
		else {
...
mxCellRenderer.prototype.getShapeConstructor = function(a) {
	var b = a.style[mxConstants.STYLE_SHAPE],
		b = b != null ? this.shapes[b] : null;
...
mxCellRenderer.prototype.configureShape = function(a) {
	...
	var b = a.view.graph.getIndicatorColor(a),
		c = a.view.graph.getIndicatorShape(a),
		c = c != null ? this.shapes[c] : null;
	if (b != null) {
		...
		if (b != null) a.shape.indicatorImage = b
	}
...
mxCellRenderer.prototype.resolveColor = function(a, b, c) {
	var d = a.shape[b],
		e = a.view.graph,
		f = null;
	if (d == "inherit") f = e.model.getParent(a.cell);
	else if (d == "swimlane") {
...
mxCellRenderer.prototype.createCellOverlays = function(a) {
	...
	a.overlays != null && a.overlays.visit(function(a, b) {
		b.destroy()
	});
	a.overlays = c
};
...
mxCellRenderer.prototype.installListeners = function(a) {
	...
	var c = mxClient.IS_TOUCH ? "touchmove" : "mousemove",
		f = mxClient.IS_TOUCH ? "touchend" : "mouseup";
	mxEvent.addListener(a.shape.node, mxClient.IS_TOUCH ? "touchstart" : "mousedown", mxUtils.bind(this, function(c) {
		this.isShapeEvent(a, c) && !e ? b.fireMouseEvent(mxEvent.MOUSE_DOWN, new mxMouseEvent(c, a.shape != null && mxEvent.getSource(c) == a.shape.content ? null : a)) : e && mxEvent.consume(c)
	}));
	...
	mxEvent.addListener(a.shape.node, f, mxUtils.bind(this, function(c) {
		this.isShapeEvent(a, c) && !e ? b.fireMouseEvent(mxEvent.MOUSE_UP, new mxMouseEvent(c, a.shape != null && mxEvent.getSource(c) == a.shape.content ? null : d(c))) : e && mxEvent.consume(c)
	}));
...
mxCellRenderer.prototype.redrawLabel = function(a) {
	...
	if (a.text == null && b != null && (mxUtils.isNode(b) || b.length > 0)) this.createLabel(a, b);
	else if (a.text != null && (b == null || b.length == 0)) {
		a.text.destroy();
		a.text = null
	}
	if (a.text != null) {
		var c = a.view.graph,
			d = c.isWrapping(a.cell),
			c = c.isLabelClipped(a.cell),
			e = this.getLabelBounds(a);
...
mxCellRenderer.prototype.getLabelBounds = function(a) {
	var b = a.view.graph,
		c = b.getModel().isEdge(a.cell),
		d = new mxRectangle(a.absoluteOffset.x, a.absoluteOffset.y);
	if (!c) {
		d.x = d.x + a.x;
		d.y = d.y + a.y;
		...
		if (b.isSwimlane(a.cell)) {
			...
			if (a.width > 0) d.width = a.width * c;
			else if (a.height > 0) d.height = a.height * c
		}
	}
	return d
};
mxCellRenderer.prototype.redrawCellOverlays = function(a) {
	this.createCellOverlays(a);
	a.overlays != null && a.overlays.visit(function(b, c) {
		var d = c.overlay.getBounds(a);
		if (c.bounds == null || c.scale != a.view.scale || !c.bounds.equals(d)) {
			c.bounds = d;
			c.scale = a.view.scale;
			c.redraw()
		}
	})
};
...
mxCellRenderer.prototype.redraw = function(a, b, c) {
	if (a.shape != null) {
		...
		if (b || a.shape.bounds == null || a.shape.scale != a.view.scale || !a.shape.bounds.equals(a) || !mxUtils.equalPoints(a.shape.points, a.absolutePoints)) {
...
var mxEdgeStyle = {
	EntityRelation: function(a, b, c, d, e) {
		...
		if (k != null) {
			...
			if (l != mxConstants.DIRECTION_MASK_NONE) h = l == mxConstants.DIRECTION_MASK_WEST;
			else {
				k = g.getCellGeometry(b.cell);
				k.relative ? h = k.x <= 0.5 : c != null && (h = c.x + c.width < b.x)
			}
		} else return;
		k = true;
		if (i != null) {
			...
			if (l != mxConstants.DIRECTION_MASK_NONE) k = l == mxConstants.DIRECTION_MASK_WEST;
			else {
		...
		if (b != null && c != null) {
			...
			if (h == k) {
				d = h ? Math.min(a, g) - d : Math.max(a, g) + d;
	...
	Loop: function(a, b, c, d, e) {
		if (b != null) {
			...
			} else a == mxConstants.DIRECTION_NORTH ? k = b.y - 2 * h : a == mxConstants.DIRECTION_SOUTH ? k = b.y + b.height + 2 * h : g = a == mxConstants.DIRECTION_EAST ? b.x - 2 * i : b.x + b.width + 2 * i;
			else if (d != null) {
				g = c.getRoutingCenterX(b);
	...
	ElbowConnector: function(a, b, c, d, e) {
		var f = d != null && d.length > 0 ? d[0] : null,
			g = false,
			h = false;
		if (b != null && c != null) if (f != null) var k = Math.min(b.x, c.x),
			i = Math.max(b.x + b.width, c.x + c.width),
			h = Math.min(b.y, c.y),
			l = Math.max(b.y + b.height, c.y + c.height),
		...
		}!h && (g || a.style[mxConstants.STYLE_ELBOW] == mxConstants.ELBOW_VERTICAL) ? mxEdgeStyle.TopToBottom(a, b, c, d, e) : mxEdgeStyle.SideToSide(a, b, c, d, e)
	},
	SideToSide: function(a, b, c, d, e) {
		...
		if (b != null && c != null) {
			...
			if (e.length == 1) if (d != null)!mxUtils.contains(c, a, d.y) && !mxUtils.contains(b, a, d.y) && e.push(new mxPoint(a, d.y));
			else {
				f = Math.max(b.y, c.y);
	...
	TopToBottom: function(a, b, c, d, e) {
		...
		if (b != null && c != null) {
			...
			!mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h) && e.push(new mxPoint(a, h));
			if (e.length == 1) if (d != null && e.length == 1)!mxUtils.contains(c, d.x, h) && !mxUtils.contains(b, d.x, h) && e.push(new mxPoint(d.x, h));
			else {
				f = Math.max(b.x, c.x);
	...
	SegmentConnector: function(a, b, c, d, e) {
		...
		if (d != null && d.length > 0) {
			for (var h = a.view.transformControlPoint(a, d[0]), l = b, m = f[0], n = false, o = false, n = h, p = d.length, q = 0; q < 2; q++) {
				var t = m != null && m.x == n.x,
					u = m != null && m.y == n.y,
					v = l != null && n.y >= l.y && n.y <= l.y + l.height,
					l = l != null && n.x >= l.x && n.x <= l.x + l.width,
					n = u || m == null && v,
					o = t || m == null && l;
				if (m != null && !u && !t && (v || l)) {
					g = v ? false : true;
			...
			g && (f[0] != null && f[0].y != h.y || f[0] == null && b != null && (h.y < b.y || h.y > b.y + b.height)) ? e.push(new mxPoint(k.x, h.y)) : !g && (f[0] != null && f[0].x != h.x || f[0] == null && b != null && (h.x < b.x || h.x > b.x + b.width)) && e.push(new mxPoint(h.x, k.y));
			g ? k.y = h.y : k.x = h.x;
		...
		g && (f[i] != null && f[i].y != h.y || f[i] == null && c != null && (h.y < c.y || h.y > c.y + c.height)) ? e.push(new mxPoint(k.x, h.y)) : !g && (f[i] != null && f[i].x != h.x || f[i] == null && c != null && (h.x < c.x || h.x > c.x + c.width)) && e.push(new mxPoint(h.x, k.y));
	...
	OrthConnector: function(a, b, c, d, e) {
		var f = a.view.graph,
			g = b == null ? false : f.getModel().isEdge(b.cell),
			f = c == null ? false : f.getModel().isEdge(c.cell);
		if (d != null && d.length > 0 || g || f) mxEdgeStyle.SegmentConnector(a, b, c, d, e);
		else {
			var d = a.absolutePoints,
				...
				q = [mxConstants.DIRECTION_MASK_ALL, mxConstants.DIRECTION_MASK_ALL];
			b != null && (q[0] = mxUtils.getPortConstraints(b, a, true, mxConstants.DIRECTION_MASK_ALL));
			c != null && (q[1] = mxUtils.getPortConstraints(c, a, false, mxConstants.DIRECTION_MASK_ALL));
			a = [0, 0];
			d = [
				[d, g, i, l],
				[m, n, o, p]
			...
			for (i = 0; i < 2; i++) {
				if (l != null) {
					...
					if (b[i][0] < 0.01) a[i] = mxConstants.DIRECTION_MASK_WEST;
					else if (b[i][0] > 0.99) a[i] = mxConstants.DIRECTION_MASK_EAST;
					b[i][1] = (l.y - d[i][1]) / d[i][3];
					if (b[i][1] < 0.01) a[i] = mxConstants.DIRECTION_MASK_NORTH;
					else if (b[i][1] > 0.99) a[i] = mxConstants.DIRECTION_MASK_SOUTH
				}
				l = null;
				c != null && (l = k)
			}
			...
			mxEdgeStyle.vertexSeperations[4] = Math.max(m - 2 * f, 0);
			...
			i < 1 && (i = i + 4);
			q < 1 && (q = q + 4);
			q = mxEdgeStyle.routePatterns[i - 1][q - 1];
			...
			case mxConstants.DIRECTION_MASK_EAST:
				mxEdgeStyle.wayPoints1[0][0] = mxEdgeStyle.wayPoints1[0][0] + (d[0][2] + f);
				mxEdgeStyle.wayPoints1[0][1] = mxEdgeStyle.wayPoints1[0][1] + b[0][1] * d[0][3];
				break;
			...
			for (i = k = 0; i < q.length; i++) {
				...
				var t = (q[i] & mxEdgeStyle.TARGET_MASK) > 0,
					o = (q[i] & mxEdgeStyle.SOURCE_MASK) > 0,
					m = (q[i] & mxEdgeStyle.SIDE_MASK) >> 5,
					m = m << g;
				m > 15 && (m = m >> 4);
				...
				if ((o || t) && m < 9) {
					...
					if (k == 0) {
						...
						m > 0 && (mxEdgeStyle.wayPoints1[f][0] = mxEdgeStyle.wayPoints1[f][0] + l[0] * m)
					} else {
			...
			for (i = 0; i <= f; i++) {
				if (i == f && (((a[1] & (mxConstants.DIRECTION_MASK_EAST | mxConstants.DIRECTION_MASK_WEST)) > 0 ? 0 : 1) == h ? 0 : 1) != (f + 1) % 2) break;
...
mxGraphView.prototype.clear = function(a, b, c) {
	var d = this.graph.getModel(),
		...
		c = c != null ? c : true;
	this.removeState(a);
	if (c && (b || a != this.currentRoot)) for (var c = d.getChildCount(a), e = 0; e < c; e++) this.clear(d.getChildAt(a, e), b);
...
mxGraphView.prototype.validateBackground = function() {
	...
	if (this.graph.pageVisible) {
		...
		if (this.backgroundPageShape == null) {
			...
			mxEvent.addListener(this.backgroundPageShape.node, "dblclick", mxUtils.bind(this, function(a) {
				...
				if (e != null) {
					if (!c.isEdge(b)) {
						...
						if (e.relative) {
							...
							d.absoluteOffset.x = this.scale * f.x;
...
mxGraphView.prototype.updateVertexLabelOffset = function(a) {
	...
	if (b == mxConstants.ALIGN_LEFT) a.absoluteOffset.x = a.absoluteOffset.x - a.width;
	else if (b == mxConstants.ALIGN_RIGHT) a.absoluteOffset.x = a.absoluteOffset.x + a.width;
	b = mxUtils.getValue(a.style, mxConstants.STYLE_VERTICAL_LABEL_POSITION, mxConstants.ALIGN_MIDDLE);
	if (b == mxConstants.ALIGN_TOP) a.absoluteOffset.y = a.absoluteOffset.y - a.height;
	else if (b == mxConstants.ALIGN_BOTTOM) a.absoluteOffset.y = a.absoluteOffset.y + a.height
};
	...
	if (d != null) {
		if (d.invalid) {
			...
			if (f != null && c.isEdge(b)) {
				...
				if (k != null && c.isEdge(k.cell) && !c.isAncestor(k.cell, b)) {
...
mxGraphView.prototype.updateFloatingTerminalPoint = function(a, b, c, d) {
	var b = this.getTerminalPort(a, b, d),
		e = this.getNextPoint(a, c, d),
		c = mxUtils.toRadians(Number(b.style[mxConstants.STYLE_ROTATION] || "0")),
		f = new mxPoint(b.getCenterX(), b.getCenterY());
	if (c != 0) var g = Math.cos(-c),
		h = Math.sin(-c),
		e = mxUtils.getRotatedPoint(e, g, h, f);
	...
	b = this.getPerimeterPoint(b, e, this.graph.isOrthogonal(a), g);
	if (c != 0) {
		g = Math.cos(c);
		h = Math.sin(c);
...
mxGraphView.prototype.updateEdgeBounds = function(a) {
	...
	if (b != null && b.length > 0) {
		var c = b[0],
			d = b[b.length - 1];
		if (c == null || d == null) a.cell != this.currentRoot && this.clear(a.cell, true);
		else {
			if (c.x != d.x || c.y != d.y) {
				var e = d.x - c.x,
					f = d.y - c.y;
...
mxGraph.prototype.cloneCells = function(a, b) {
	...
	if (a != null) {
		...
		if (c.length > 0) for (var f = this.view.scale, g = this.view.translate, c = this.model.cloneCells(a, true), e = 0; e < a.length; e++) if (!b && this.model.isEdge(c[e]) && this.getEdgeValidationError(c[e], this.model.getTerminal(c[e], true), this.model.getTerminal(c[e], false)) != null) c[e] = null;
		else {
			...
			for (c = 0; c < a.length; c++) {
				...
				if (e != null) for (d = 0; d < e.length; d++) {
					var f = this.view.getState(e[d]),
						...
						i = mxCellPath.create(h);
					(b[k] == null || b[i] == null) && this.resetEdge(e[d])
				}
...
mxGraph.prototype.getEdges = function(a, b, c, d, e, f) {
	...
	for (i = 0; i < g.length; i++) {
		...
		l = l != null ? l.getVisibleTerminal(false) : this.view.getVisibleTerminal(g[i], false);
...
mxGraph.prototype.getEdgesBetween = function(a, b, c) {
	for (var c = c != null ? c : false, d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
		var g = this.view.getState(d[f]),
			...
			g = g != null ? g.getVisibleTerminal(false) : this.view.getVisibleTerminal(d[f], false);
			...
			if (d == null || d) {
				...
				if (d > 0) for (f = 0; f < d; f++) {
					var g = this.model.getEdgeAt(a, f),
						h = this.model.getTerminal(g, true) == a;
...
mxCellOverlay.prototype.getBounds = function(a) {
	...
	if (b) {
		b = a.absolutePoints;
		if (b.length % 2 == 1) d = b[Math.floor(b.length / 2)];
		else {
			d = b.length / 2;
			a = b[d - 1];
			b = b[d];
	...
	if (this.active) {
		...
		if (Math.abs(c) > 0 || Math.abs(d) > 0) {
			if (this.zoom) {
				...
				this.source.getView().setTranslate(e.x - c, e.y - d)
			}
			this.update();
			b.consume()
		}
...
mxLayoutManager.prototype.beforeUndo = function(a) {
	var a = this.getCellsForChanges(a.changes),
		b = this.getGraph().getModel();
...
mxSpaceManager.prototype.cellResized = function(a) {
	...
	if (e != null && f != null) {
		...
		if (g != null && h != null) {
			var k = c.translate,
				i = c.scale,
				c = e.x - f.origin.x - k.x * i,
				f = e.y - f.origin.y - k.y * i,
				k = e.x + e.width,
				l = e.y + e.height,
				m = e.width - h.width * i + c - h.x * i,
				n = e.height - h.height * i + f - h.y * i,
				o = 1 - h.width * i / e.width,
				e = 1 - h.height * i / e.height;
			d.beginUpdate();
			try {
				for (h = 0; h < g.length; h++) g[h] != a && this.isCellShiftable(g[h]) && this.shiftCell(g[h], m, n, c, f, k, l, o, e, this.isExtendParents() && b.isExtendParent(g[h]))
			} finally {
				d.endUpdate()
			}
		}
...
mxSwimlaneManager.prototype.isCellHorizontal = function(a) {
	if (this.graph.isSwimlane(a)) {
		var b = this.graph.view.getState(a),
			a = b != null ? b.style : this.graph.getCellStyle(a);
...
mxCellStatePreview.prototype.translateState = function(a, b, c, d) {
	if (b != null) {
		...
		if (e.isVertex(b.cell)) {
			...
			var a = e.getGeometry(b.cell),
				f = mxCellPath.create(b.cell);
...
mxCellStatePreview.prototype.revalidateState = function(a, b, c, d, e) {
	if (b != null) {
		...
		for (f = 0; f < a; f++) this.revalidateState(b, this.graph.view.getState(g.getChildAt(b.cell, f)), c, d, e)
	}
};
	...
	if (!b.isConsumed() && this.isEnabled() && this.graph.isEnabled() && !this.graph.isForceMarqueeEvent(b.getEvent()) && b.getState() != null) {
		...
		if (this.isMoveEnabled()) {
			var d = this.graph.model,
				e = d.getGeometry(c);
			this.graph.isCellMovable(c) && (!d.isEdge(c) || this.graph.getSelectionCount() > 1 || e.points != null && e.points.length > 0 || d.getTerminal(c, true) == null || d.getTerminal(c, false) == null || this.graph.allowDanglingEdges || this.graph.isCloneEvent(b.getEvent()) && this.graph.isCellsCloneable()) && this.start(c, b.getX(), b.getY());
			this.cellWasClicked = true;
			if (!mxClient.IS_SF && !mxClient.IS_GC || b.getSource().nodeName != "SELECT") b.consume();
			else if (mxClient.IS_SF && b.getSource().nodeName == "SELECT") {
...
mxGraphHandler.prototype.mouseMove = function(a, b) {
	...
	if (!b.isConsumed() && c.isMouseDown && this.cell != null && this.first != null && this.bounds != null) {
		...
		if (this.shape != null || Math.abs(e) > d || Math.abs(f) > d) {
			...
			var h = c.isCloneEvent(b.getEvent()) && c.isCellsCloneable() && this.isCloneEnabled(),
				k = c.getView().getState(e),
				i = false;
			if (k != null && f == null && (g.getParent(this.cell) != e || h)) {
				...
				this.target = null;
				if (this.connectOnDrop && d != null && this.cells.length == 1 && c.getModel().isVertex(d) && c.isCellConnectable(d)) {
	...
	if (!b.isConsumed()) {
		...
		if (this.cell != null && this.first != null && this.shape != null && this.currentDx != null && this.currentDy != null) {
			var d = c.getView().scale,
				...
				d = this.currentDy / d,
				g = b.getCell();
			if (this.connectOnDrop && this.target == null && g != null && c.getModel().isVertex(g) && c.isCellConnectable(g) && c.isEdgeValid(null, this.cell, g)) c.connectionHandler.connect(this.cell, g, b.getEvent());
			else {
				g = this.target;
...
mxCellMarker.prototype.process = function(a) {
	...
	if (this.isEnabled()) {
		var b = this.getState(a),
			c = b != null ? this.isValidState(b) : false,
...
mxEdgeHandler.prototype.init = function() {
	...
	var a = mxClient.IS_TOUCH ? "touchstart" : "mousedown",
		b = mxClient.IS_TOUCH ? "touchmove" : "mousemove",
		c = mxClient.IS_TOUCH ? "touchend" : "mouseup";
	...
	mxEvent.addListener(this.shape.node, b, mxUtils.bind(this, function(a) {
		var b = this.state.cell;
		if (this.index != null) {
			var c = mxUtils.convertPoint(this.graph.container, mxEvent.getClientX(a), mxEvent.getClientY(a)),
				b = this.graph.getCellAt(c.x, c.y);
...
mxEdgeHandler.prototype.getHandleForEvent = function(a) {
	...
	if (a.isSource(this.labelShape) || a.isSource(this.state.text)) if (!mxClient.IS_SF && !mxClient.IS_GC || a.getSource().nodeName != "SELECT") return mxEvent.LABEL_HANDLE;
	return null
};
...
mxEdgeHandler.prototype.getPointForEvent = function(a) {
	...
	if (this.snapToTerminals && c > 0) {
		...
		if (this.abspoints != null) for (h = 0; h < this.abspoints; h++) h != this.index && g.call(this, this.abspoints[h])
	}
...
mxEdgeHandler.prototype.updatePreviewState = function(a, b, c) {
	var d = this.isSource ? c : this.state.getVisibleTerminalState(true),
		e = this.isTarget ? c : this.state.getVisibleTerminalState(false),
		f = this.graph.getConnectionConstraint(a, d, true),
		g = this.graph.getConnectionConstraint(a, e, false),
	...
	(!this.isTarget || e != null) && a.view.updateFixedTerminalPoint(a, e, false, g);
	...
	if (this.index != null && this.marker != null) {
		...
		if (this.isLabel) {
			...
			var d = this.isSource || this.isTarget ? this.getPreviewTerminalState(b) : null,
				e = this.clonePreviewState(c, d != null ? d.cell : null);
...
mxEdgeHandler.prototype.mouseUp = function(a, b) {
	if (this.index != null && this.marker != null) {
		...
		if (b.getX() != this.startX || b.getY() != this.startY) if (this.error != null) this.error.length > 0 && this.graph.validationAlert(this.error);
		else if (this.isLabel) this.moveLabel(this.state, this.label.x, this.label.y);
		else if (this.isSource || this.isTarget) {
			var d = null;
			if (this.constraintHandler.currentConstraint != null && this.constraintHandler.currentFocus != null) d = this.constraintHandler.currentFocus.cell;
			if (d == null && this.marker.hasValidState()) d = this.marker.validState.cell;
			if (d != null) c = this.connect(c, d, this.isSource, this.graph.isCloneEvent(b.getEvent()) && this.cloneEnabled && this.graph.isCellsCloneable(), b);
...
mxEdgeHandler.prototype.addPoint = function(a, b) {
	...
	if (c != null) {
		var c = c.clone(),
			d = mxUtils.convertPoint(this.graph.container, mxEvent.getClientX(b), mxEvent.getClientY(b)),
			e = mxUtils.findNearestSegment(a, d.x, d.y),
			f = this.graph.isGridEnabledEvent(b);
...
mxEdgeHandler.prototype.getHandleFillColor = function(a) {
	...
	if (c != null && !this.graph.isCellDisconnectable(b, c, a) || c == null && !this.graph.isTerminalPointMovable(b, a)) d = mxConstants.LOCKED_HANDLE_FILLCOLOR;
	else if (c != null && this.graph.isCellDisconnectable(b, c, a)) d = mxConstants.CONNECT_HANDLE_FILLCOLOR;
	return d
};
...
mxEdgeHandler.prototype.redrawInnerBends = function() {
	...
	if (a != null) {
		...
		for (var b = 1; b < this.bends.length - 1; b++) if (this.bends[b] != null) if (this.abspoints[b] != null) {
			var c = this.abspoints[b].x,
				d = this.abspoints[b].y,
				e = this.bends[b].bounds;
...
mxElbowEdgeHandler.prototype.redrawInnerBends = function(a, b) {
	var c = this.graph.getModel().getGeometry(this.state.cell).points,
		c = c != null ? c[0] : null,
		c = c == null ? new mxPoint(a.x + (b.x - a.x) / 2, a.y + (b.y - a.y) / 2) : new mxPoint(this.graph.getView().scale * (c.x + this.graph.getView().translate.x + this.state.origin.x), this.graph.getView().scale * (c.y + this.graph.getView().translate.y + this.state.origin.y)),
		d = this.bends[1].bounds,
		e = d.width,
		d = d.height;
	if (this.handleImage == null) d = e = mxConstants.HANDLE_SIZE;
	var f = new mxRectangle(c.x - e / 2, c.y - d / 2, e, d);
...
mxEdgeSegmentHandler.prototype.getPreviewPoints = function(a) {
	...
	if (d.length == 1) {
		...
		if (f != null & e != null) if (mxUtils.contains(f, d[0].x, d[0].y)) b[1].y == b[2].y ? d[0].y = c.getRoutingCenterY(e) : d[0].x = c.getRoutingCenterX(e);
		else if (mxUtils.contains(e, d[0].x, d[0].y)) b[1].y == b[0].y ? d[0].y = c.getRoutingCenterY(f) : d[0].x = c.getRoutingCenterX(f)
	} else d.length == 0 && (d = [a]);
	return d
};
mxEdgeSegmentHandler.prototype.createBends = function() {
	...
	if (this.graph.isCellBendable(this.state.cell)) {
		...
		for (var d = 0; d < c.length - 1; d++) {
			...
			a.push(b);
			b.node.style.cursor = c[d].x - c[d + 1].x == 0 ? "col-resize" : "row-resize";
			this.points.push(new mxPoint(0, 0));
			mxClient.IS_TOUCH && b.node.setAttribute("pointer-events", "none")
		}
	}
...
mxEdgeSegmentHandler.prototype.redrawInnerBends = function(a, b) {
	if (this.graph.isCellBendable(this.state.cell)) {
		...
		if (d != null && d.length > 1) for (var e = 0; e < this.state.absolutePoints.length - 1; e++) if (this.bends[e + 1] != null) {
			var a = d[e],
				b = d[e + 1],
				f = new mxPoint(a.x + (b.x - a.x) / 2, a.y + (b.y - a.y) / 2);
...
mxKeyHandler.prototype.keyDown = function(a) {
	if (this.graph.isEnabled() && !mxEvent.isConsumed(a) && this.isGraphEvent(a) && this.isEnabled()) if (a.keyCode == 27) this.escape(a);
...
mxCellHighlight.prototype.repaint = function() {
	if (this.state != null && this.shape != null) {
		...
		var a = !this.graph.model.isEdge(this.state.cell) ? Number(this.state.style[mxConstants.STYLE_ROTATION] || "0") : 0;
		if (this.shape.dialect == mxConstants.DIALECT_SVG) {
			this.shape.node.setAttribute("style", "pointer-events:none;");
			if (a != 0) {
				var b = this.state.getCenterX(),
					c = this.state.getCenterY();
...
mxDefaultPopupMenu.prototype.addItems = function(a, b, c, d, e, f, g) {
	for (var h = false; f != null;) {
		if (f.nodeName == "add") {
			...
			if (k == null || e[k]) {
				var k = f.getAttribute("as"),
					...
					i = mxUtils.eval(mxUtils.getTextContent(f)),
					l = f.getAttribute("action"),
					m = f.getAttribute("icon"),
					n = f.getAttribute("iconCls");
				if (h) {
					b.addSeparator(g);
					h = false
				}
		...
		} else f.nodeName == "separator" && (h = true);
		f = f.nextSibling
	}
};
...
mxEditor.prototype.createSession = function() {
	return this.connect(this.urlInit, this.urlPoll, this.urlNotify, mxUtils.bind(this, function(a) {
